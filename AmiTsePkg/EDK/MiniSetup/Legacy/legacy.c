...
{
    gMsgBox.Initialize = (EFI_STATUS(*)(void*,void*))LegacyMsgBoxInitialize ;
    gSubMenu.Initialize = (EFI_STATUS(*)(void*,void*))LegacySubMenuInitialize ;
    gSubMenu.Draw = (EFI_STATUS(*)(void*))LegacySubMenuDraw ;
    gFrame.Draw = (EFI_STATUS(*)(void*))LegacyFrameDraw ;  // Override framedraw
	gFrame.AddControl = LegacyFrameAddControl ;     // Override FrameAddControl
    gPage.HandleAction = (EFI_STATUS(*)(void*,ACTION_DATA*))LegacyPageHandleAction ;   // Override FrameAddControl
...
EFI_STATUS StyleInitRecalculateFrames (FRAME_INFO *StyleFullSubFrames , FRAME_INFO *StyleFullMainFrames)
{
   ...
   {               
        ...
        gControlLeftMargin = (((gMaxCols  * 2/3) - gLabelLeftMargin) / 2); 
        return EFI_SUCCESS;
    }
