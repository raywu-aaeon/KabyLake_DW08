...
EFI_STATUS TSE_SOFTKBD_GetMouseCoordinates (DXE_MOUSE_PROTOCOL *This, INT32 *X, INT32 *Y, INT32 *Z)
{
    ...
    if (TSESoftKbd_n->SoftKbdActive) //if softkbd active
    {
    	...
    	TSEMouse->GetCoordinates(TSEMouse, (INT32 *)&x, (INT32 *)&y, (INT32 *)&z);
...
EFI_STATUS TSEMouseReadInfo(MOUSE_INFO *MouseInfo)
{
   ...
   TSEMouse->GetButtonStatus(TSEMouse,(INT32 *)&Button_Status);     
...
TSEIsMouseOnSoftkbd(VOID)
{
    ...
    TSESoftKbd_n->GetPosition(TSESoftKbd_n, FALSE ,(UINT32 *)&SoftKbdStartY, (UINT32 *)&SoftKbdStartX);
    TSESoftKbd_n->GetDimension(TSESoftKbd_n, (UINT32 *)&SoftKbdWidth, (UINT32 *)&SoftKbdHeight);
...
BOOLEAN IsSoftKbdonCurrentRow(UINT32 TOP)
{
	...
	UINT32 SoftKbdStartX = 0, SoftKbdStartY = 0, SoftKbdWidth = 0, SoftKbdHeight = 0;
	UINT32 SoftKbdStartY1 = 0, SoftKbdStartY2 = 0;
	UINT32 ScreenTop=0;
