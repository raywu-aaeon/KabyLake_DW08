...
INTN BBS_GetKey(VOID)
{
    ...
    return (INTN)((Key.ScanCode<<16)|Key.UnicodeChar);
}
...
VOID SetProgressBarQuiteBootActive(BOOLEAN quiteBootActive)
{
    gProgress->quiteBootActive = quiteBootActive ;
}
...
{
	UINTN CurrXPos = 0,CurrYPos = 0,Attribute = 0;
