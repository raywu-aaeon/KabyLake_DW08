...
#pragma warning( disable : 4221 ) // to suppress warnign (for SetupDebugItems)- 'identifier' : cannot be initialized using address of automatic variable
#pragma warning( disable : 4204 ) // to suppress warning (for SetupDebugItems)- nonstandard extension used : non-constant aggregate initializer
#endif
...
#if SERIAL_DEBUG
//    TRACE(TRACE_TSE, Format, Marker);

  trace = StrDup16to8(tmpBuffer);
  TRACE ((TRACE_TSE, trace));
