...
AMI_SERIAL_PROTOCOL gAmiSerialUart2Protocol = {
  GetBaseAddress,
  CheckPciMmio,
  GetPciLocation,
  GetSerialIRQ,
...
//      PcieBase = MmPciAddress (SERIAL_UART2_MMIO_AT_BUS, SERIAL_UART2_MMIO_AT_DEV, SERIAL_UART2_MMIO_AT_FUN, 0);
//      *BaseAddress = (MmioRead32 (PcieBase + PCI_BASE_ADDRESSREG_OFFSET + 8 * SERIAL_UART_DEV_BAR_NUMBER) & 0xFFFFF000);
    ...
    if (SERIAL_UART_DEV_IS_MMIO) {	
		PcieBase = MmPciAddress (   SERIAL_UART2_MMIO_AT_BUS, 
                                    SERIAL_UART2_MMIO_AT_DEV, 
                                    SERIAL_UART2_MMIO_AT_FUN, 
                                    0);
...
{
    *Bus  = SERIAL_UART_DEV_IS_MMIO ? SERIAL_UART2_MMIO_AT_BUS : 0xff;
    *Dev  = SERIAL_UART_DEV_IS_MMIO ? SERIAL_UART2_MMIO_AT_DEV : 0xff;
    *Func = SERIAL_UART_DEV_IS_MMIO ? SERIAL_UART2_MMIO_AT_FUN : 0xff;
  ...
  )
{
  ...
  Status = SystemTable->BootServices->InstallMultipleProtocolInterfaces (
              &gHandle, 
              &gAmiSerialProtocolGuid,   &gAmiSerialUart2Protocol,
