...
// Override EFP2_DTD
...

  {
    ...
    UINT8 DTD_800x600[18] = {0x8B, 0x0F, 0x20, 0x00, 0x31, 0x58, 0x1C, 0x20, 0x28, 0x80, 0x14, 0x00, 0x2C, 0xC8, 0x10, 0x00, 0x00, 0x1A};

    pBS->CopyMem ( (VOID *)((UINT32)ImageStart + ((0xB30) + (0x30) + (0x7F2) + (3))), &DTD_800x600, 18 );
