...
External(ASL_SG_ULT_RP_NUM.TGPC, IntObj)
External(ASL_SG_ULT_RP_NUM.DGCX, IntObj)
External(ASL_SG_ULT_RP_NUM.TDGC, IntObj)
...
#else
    Store(Zero, ASL_PCI_SCOPE.LKD9)
#endif
    If(LEqual(\_SB.GGIV(ASL_GPIO_GC6_FB_EN), One))
    {
      // Asserts GPU_EVENT#    
      ASL_PCI_SCOPE.SGPO(ASL_EXPANDER_GPU_EVENT, ASL_GPIO_GPU_EVENT, ASL_ACTIVE_GPU_EVENT, One)
    // Sensing GC6_FB_EN = 0
      ...
      ASL_PCI_SCOPE.SGPO(ASL_EXPANDER_GPU_EVENT, ASL_GPIO_GPU_EVENT, ASL_ACTIVE_GPU_EVENT, Zero)
    }
#if ASL_GC6_ELINK_METHOD_SUPPORT == 1
    G6EL(3)
#endif    
	        ...
	        case(0x00000003)
    		{
				...
				CreateField(Arg3,0x10,0x03,GPCX)
								...
								//
                                                                ...
                                                                {
                                                                               Store (ToInteger (DFGC), ASL_SG_ULT_RP_NUM.TDGC)
                                                                               Store (ToInteger (GPCX), ASL_SG_ULT_RP_NUM.DGCX)
