...
External(\_PR.PR00._PSS, BuffObj)
External(\_PR.PR00._TSS, BuffObj)

External(\_PR.PR00._PPC, IntObj)
External(\_PR.PR01._PPC, IntObj)
External(\_PR.PR02._PPC, IntObj)
External(\_PR.PR03._PPC, IntObj)
External(\_PR.PR04._PPC, IntObj)
External(\_PR.PR05._PPC, IntObj)
External(\_PR.PR06._PPC, IntObj)
External(\_PR.PR07._PPC, IntObj)

External(\_PR.PR00._TPC, IntObj)
External(\_PR.PR01._TPC, IntObj)
External(\_PR.PR02._TPC, IntObj)
External(\_PR.PR03._TPC, IntObj)
External(\_PR.PR04._TPC, IntObj)
External(\_PR.PR05._TPC, IntObj)
External(\_PR.PR06._TPC, IntObj)
External(\_PR.PR07._TPC, IntObj)
