...
/** @file AmiHpetApicLib.h
  This file contains South Bridge(LPC) chipset porting library HPET APIC 
  functions and data structure definitions for both PEI & DXE stages.
  
*/

#ifndef __AMI_HPET_APIC_LIB_H__
#define __AMI_HPET_APIC_LIB_H__
