...
; AMI_OVERRIDE_START - Program 8259 Interrupt Controller to disable all interrupts
  mov al, 0FFh
  out 21h, al    ;; Mask off all interrupts in master 8259
  out 0a1h, al   ;; Mask off all interrupts in slave 8259
; AMI_OVERRIDE_END - Program 8259 Interrupt Controller to disable all interrupts
