  ...
  )
{
  ...
  GtPreMemConfig->GttMmAdr      = (UINTN) PcdGet64 (PcdGttMmAddress);
  GtPreMemConfig->GmAdr = (UINTN) PcdGet64 (PcdGmAdrAddress);
  ...
  MiscPeiPreMemConfig->UserBd = PlatformBoardConfig->UserBd;
  MiscPeiPreMemConfig->MmioSizeAdjustment = PlatformBoardConfig->MmioSizeAdjustment;

  PciePeiPreMemConfig->PegGpioData.SaPegReset.GpioPad = PlatformBoardConfig->GpioPad;
  PciePeiPreMemConfig->PegGpioData.SaPegReset.Active = PlatformBoardConfig->Active;
