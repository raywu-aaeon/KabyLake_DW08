  ...
  )
{
  ...
  //
// AMI_OVERRIDE_START - ACPI Base Address is in D31/F2
//  IoWrite32 (0xcf8, 0x8000f840);
  IoWrite32 (0xcf8, 0x8000fa40);  
// AMI_OVERRIDE_END - ACPI Base Address is in D31/F2
  IoWrite32 (0xcfc, PcdGet16 (PcdAcpiBaseAddress));
// AMI_OVERRIDE_START - ACPI Base Address is in D31/F2
//  IoWrite32 (0xcf8, 0x8000f844);
  IoWrite32 (0xcf8, 0x8000fa44);  
// AMI_OVERRIDE_END -  ACPI Base Address is in D31/F2
  IoWrite8 (0xcfc, IoRead8 (0xcfc) | 0x80);
  ...
  //
// AMI_OVERRIDE_START - Don't support Lava Canyon.
//  CheckNct6776fSio ();
// AMI_OVERRIDE_END - Don't support Lava Canyon.

  //
  // Initialize ICH to write port 80 to onboard device
  //
  IoWrite32 (0xcf8, 0x8000f8f0);
  IoWrite32 (0xcfc, (UINTN) PcdGet64 (PcdHeciF4BaseAddress) | 1);
