    ...
    )
{
  ...
  External(\_SB.PCI0.PEG0.PEGP.SGPO, MethodObj)
  External(\_SB.PCI0.PEG0.PEGP.SGPI, MethodObj)
  External(TGOC)
  External(RDCM, MethodObj)
  External(WRCM, MethodObj)
  External(\ADBG, MethodObj)
  Include("Atpx.asl")
  Include("Pxport.asl")
  Include("AtifSg.asl")
  Include("AtifDgpu.asl")
}
