/** @file
    Skylake-Halo LPDDR3 Rvp16 HSIO PTSS H File
...
#ifndef SKYLAKE_HALO_LPDDR3_RVP16_HSIO_PTSS_H_
#define SKYLAKE_HALO_LPDDR3_RVP16_HSIO_PTSS_H_

#include <Library/PeiPolicyUpdateLib/PchHsioPtssTables.h>

//BoardId SkylakeHaloLpddr3Rvp16
HSIO_PTSS_TABLES PchHHsioPtss_Bx_SkylakeHaloLpddr3Rvp16[] = {
  ...
  {{22, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x03000000, (UINT32) ~0x3F000000}, PchSataTopoM2},
  ...
  {{23, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoIsata},
  ...
  {{26, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x03000000, (UINT32) ~0x3F000000}, PchSataTopoM2},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Bx_SkylakeHaloLpddr3Rvp16);

//BoardId SkylakeHaloLpddr3Rvp16
HSIO_PTSS_TABLES PchHHsioPtss_Dx_SkylakeHaloLpddr3Rvp16[] = {
  {{4, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{5, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{6, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{7, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Dx_SkylakeHaloLpddr3Rvp16);

#endif // SKYLAKE_HALO_LPDDR3_RVP16_HSIO_PTSS_H_
