/** @file
    Skylake-Y Rvp13 HSIO PTSS H File
...
#ifndef SKYLAKE_Y_RVP13_HSIO_PTSS_H_
#define SKYLAKE_Y_RVP13_HSIO_PTSS_H_

#include <Library/PeiPolicyUpdateLib/PchHsioPtssTables.h>

//BoardId SkylakeYRvp13
HSIO_PTSS_TABLES PchLpHsioPtss_Bx_SkylakeYRvp13[] = {
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x04000000, (UINT32) ~0x3F000000}, PchPcieTopoUnknown},
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  ...
  {{10, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x03000000, (UINT32) ~0x3F000000}, PchSataTopoDirectConnect},
  {{10, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  ...
  {{12, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  {{12, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{13, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  {{13, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{14, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  {{14, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{14, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{15, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  ...
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchPcieTopoUnknown},
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoUnknown},
  {{10, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoDirectConnect},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchLpHsioPtss_Bx_SkylakeYRvp13);

//BoardId SkylakeYRvp13
HSIO_PTSS_TABLES PchLpHsioPtss_Cx_SkylakeYRvp13[] = {
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x04000000, (UINT32) ~0x3F000000}, PchSataTopoM2},
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0x150, 0x05000000, (UINT32) ~0x3F000000}, PchSataTopoUnknown},
  {{11, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  ...
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoM2},
  {{11, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoUnknown},
  {{10, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoDirectConnect},
  {{10, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoUnknown},
  {{15, V_PCH_PCR_FIA_LANE_OWN_SATA, 0xa0, 0x00000000, (UINT32) ~0x3F3F00}, PchSataTopoUnknown},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchLpHsioPtss_Cx_SkylakeYRvp13);

#endif // SKYLAKE_Y_RVP13_HSIO_PTSS_H_
