...
@par Specification
**/
#ifndef _GPIO_TABLE_AIO_RVP9_CRB_H
#define _GPIO_TABLE_AIO_RVP9_CRB_H

static GPIO_INIT_CONFIG mGpioTableAioRvp9Crb[] =
{
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A6,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirInOut   , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermNone }}, //INT_SERIRQ_ESPI_CS1_N
  // Not Used {GPIO_SKL_H_GPP_A7, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioIntDis      , GpioReset       , GpioTerm        }}, //PIRQAB_ESPI_ALERT0_N/Not Used
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A9,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioPlatformReset , GpioTermWpd20K  }}, //LPC_CLK_ESPI_CLK
  ...
  //Not Used  {GPIO_SKL_H_GPP_A12, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioIntDis      , GpioReset       , GpioTerm        }}, //BM_BUSYB_ISH_GP_6/NOT USED
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A14, {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioHostDeepReset   , GpioTermNone }}, //PM_SUS_STAT_ESPI_RST_N
  ...
  {GPIO_SKL_H_GPP_A23, {GpioPadModeGpio   , GpioHostOwnAcpi   , GpioDirIn      , GpioOutDefault, GpioIntEdge      | GpioIntSci, GpioHostDeepReset   , GpioTermNone }}, //ISH_GP_5/FPS_DRDY (All SKU)
  // Not Used {GPIO_SKL_H_GPP_B0, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioReset       , GpioTerm        }}, //NOT USED
  ...
  {GPIO_SKL_H_GPP_B15, {GpioPadModeGpio   , GpioHostOwnDefault   , GpioDirOut     , GpioOutLow    , GpioIntDis      , GpioPlatformReset , GpioTermNone }}, //GSPI0_CSB / NFC_FW_DL
  ...
  {GPIO_SKL_H_GPP_E0,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermWpu20K  }}, //SATAXPCIE_0_SATAGP_0_VISA2CH1_CLK/SATAE1_IFDET
  {GPIO_SKL_H_GPP_E1,  {GpioPadModeNative2, GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermWpu20K  }}, //SATAXPCIE_1_SATAGP_1_VISA2CH1_D0/SATAE1_IFDET
  ...
  {GPIO_SKL_H_GPP_E4,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioPlatformReset , GpioTermNone }}, //SATA_DEVSLP_0_VISA2CH1_D3/SATAE1_DEVSLP
  {GPIO_SKL_H_GPP_E5,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioHostDeepReset   , GpioTermNone    }}, //SATA_DEVSLP_1_VISA2CH1_D4/PCH_NFC_RESET
  ...
  //{GPIO_SKL_H_GPP_E7,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirInInv   , GpioOutDefault, GpioIntLevel     | GpioIntSci, GpioPlatformReset , GpioTermNone    }}, //CPU_GP1__VISA2CH1_D6/TCH_PNL_INTR_N
  ...
  {GPIO_SKL_H_GPP_F23, {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntLevel     | GpioIntApic, GpioHostDeepReset   , GpioTermNone    }}, //NFC_IRQ
  ...
  // Native mode pins are configured seperately {GPIO_SKL_H_GPP_H2,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermNone }}, //SRCCLKREQB_8/PCIEX16_PRSNT2_N
  ...
  // {GPIO_SKL_H_GPP_H4,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermNone }}, //SRCCLKREQB_10/CLK_REQ10_SATAE1_N
  ...
  {GPIO_SKL_H_GPP_H10, {GpioPadModeGpio   , GpioHostOwnDefault   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioHostDeepReset   , GpioTermNone }}, //SML2CLK/MP_GP_2
  {GPIO_SKL_H_GPP_H11, {GpioPadModeGpio   , GpioHostOwnDefault   , GpioDirIn      , GpioOutDefault, GpioIntDis      , GpioHostDeepReset   , GpioTermNone }}, //SML2DATA/MP_GP_1
  ...
  // Not Used {GPIO_SKL_H_GPP_H16, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioReset       , GpioTerm        }}, //SML4CLK/Not Used
  // Not Used {GPIO_SKL_H_GPP_H17, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioReset       , GpioTerm        }}, //SML4DATA/Not Used
  ...
  // Not Used {GPIO_SKL_H_GPD0, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioReset       , GpioTerm        }}, //PM_BATLOW_R_N/NOT USED
...
static GPIO_INIT_CONFIG mGpioTableKabyLakeDtDdr4Rvp9Ev[] =
{
  {GPIO_SKL_H_GPP_B5,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_B12,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_D11,  {GpioPadModeNative2, GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDefault, GpioHostDeepReset, GpioTermNone}},  // ISH_MISO_USBC_BP_DCI_CLK_R
  {GPIO_SKL_H_GPP_D12,  {GpioPadModeNative2, GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDefault, GpioHostDeepReset, GpioTermNone}},  // ISH_MOSI_USBC_BP_DCI_DATA_R
  {GPIO_SKL_H_GPP_E0,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // VISACH1_CLK_PCH_GPP
  {GPIO_SKL_H_GPP_E1,   {GpioPadModeNative2, GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDefault, GpioPlatformReset, GpioTermNone}},  // VISACH1_D0_GPP_E_1/SATA_ODD_PRSNT_R_N
  {GPIO_SKL_H_GPP_E2,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // VISACH1_D1_PCH_GPP_E_2
  {GPIO_SKL_H_GPP_F0,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // VISACH2_D4_PCH_GPP_F_0
  {GPIO_SKL_H_GPP_F7,   {GpioPadModeGpio   , GpioHostOwnGpio,   GpioDirOut, GpioOutHigh,    GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // DGPU_SEL_N
  {GPIO_SKL_H_GPP_F8,   {GpioPadModeGpio   , GpioHostOwnGpio,   GpioDirOut, GpioOutHigh,    GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // DGPU_PWR_EN_N
  {GPIO_SKL_H_GPP_F9,   {GpioPadModeGpio   , GpioHostOwnGpio, GpioDirInInv, GpioOutLow,     GpioIntLevel,   GpioPlatformReset, GpioTermNone }}, // DGPU_PWR_OK
  {GPIO_SKL_H_GPP_F17,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDefault, GpioHostDeepReset, GpioTermNone}},  // USBC_BP_OC_R_N
  {GPIO_SKL_H_GPP_F19,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_F20,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_F21,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_G1,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_G2,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_G15,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_G17,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_H3,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_H10,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_H11,  {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_H16,  {GpioPadModeGpio   , GpioHostOwnAcpi, GpioDirInInv, GpioOutDefault, GpioIntLevel | GpioIntSci, GpioPlatformReset, GpioTermNone } }, // SATA_ODD_DA_R_N
  {GPIO_SKL_H_GPP_H17,  {GpioPadModeGpio   , GpioHostOwnGpio,   GpioDirOut, GpioOutHigh,    GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // SATA_ODD_PWRGT
  {GPIO_SKL_H_GPP_I4,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_I5,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_I6,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_I7,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
  {GPIO_SKL_H_GPP_I8,   {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirIn, GpioOutDefault, GpioIntDis,     GpioPlatformReset, GpioTermNone }}, // Not Used
};

GPIO_INIT_CONFIG mGpioTableAioRvp9CrbTouchpanel = {GPIO_SKL_H_GPP_E7, {GpioPadModeGpio,    GpioHostOwnGpio, GpioDirIn,    GpioOutDefault, GpioIntLevel | GpioIntApic, GpioPlatformReset,  GpioTermNone}};


#endif  // _GPIO_TABLE_AIO_RVP9_CRB_H
