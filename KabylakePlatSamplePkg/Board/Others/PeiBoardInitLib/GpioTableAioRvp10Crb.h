...
@par Specification
**/
#ifndef _GPIO_TABLE_AIO_RVP10_CRB_H
#define _GPIO_TABLE_AIO_RVP10_CRB_H

static GPIO_INIT_CONFIG mGpioTableAioRvp10Crb[] =
{
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A9,  {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioPlatformReset , GpioTermWpd20K  }}, //LPC_CLK_ESPI_CLK
  ...
  {GPIO_SKL_H_GPP_A12, {GpioPadModeGpio, GpioHostOwnGpio, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioHostDeepReset   , GpioTermNone    }}, //SX_EXIT_HOLDOFF_R_N
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A14, {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioHostDeepReset   , GpioTermNone    }}, //PM_SUS_STAT_ESPI_RST_N
  ...
  {GPIO_SKL_H_GPP_G1,  {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutLow    , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //FAN_TACH_1/SATA_ODD_PWRGT_R
  {GPIO_SKL_H_GPP_G2,  {GpioPadModeGpio   , GpioHostOwnAcpi   , GpioDirIn      , GpioOutDefault, GpioIntBothEdge  | GpioIntSci, GpioPlatformReset , GpioTermWpu20K  }}, //FAN_TACH_2/SATA_ODD_DA_INT_N
...
static GPIO_INIT_CONFIG mGpioTableUsffCpv[] =
{
  ...
  {GPIO_SKL_H_GPP_B20, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutLow    , GpioIntDefault  , GpioHostDeepReset , GpioTermNone    }}, //GPIO_PCIE_RST
  ...
  {GPIO_SKL_H_GPP_D10, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioDirDefault, GpioIntDefault  , GpioHostDeepReset , GpioTermNone    }}, // M.2 SSD2 RESET
  {GPIO_SKL_H_GPP_D11, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioDirDefault, GpioIntDefault  , GpioPlatformReset , GpioTermWpd20K}}, //TB_FRC_PWR_R
  {GPIO_SKL_H_GPP_D12, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInOut   , GpioDirDefault, GpioIntDefault  , GpioHostDeepReset , GpioTermNone    }}, //M.2_SSD2_PWREN
...
#endif  // _GPIO_TABLE_AIO_RVP10_CRB_H
