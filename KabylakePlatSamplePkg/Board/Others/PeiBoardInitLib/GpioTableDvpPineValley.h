...
@par Specification
**/
#ifndef _GPIO_TABLE_DVP_PINEVALLEY_H
#define _GPIO_TABLE_DVP_PINEVALLEY_H

//
// @todo !!! This table is from RVP10 !!!
// @todo !!! Please update to match Pine Valley !!!
//
static GPIO_INIT_CONFIG mGpioTableDvpPineValley[] =
{
...
//skip for eSPI function  {GPIO_SKL_H_GPP_A14, {GpioPadModeNative1, GpioHostOwnDefault, GpioDirOut     , GpioOutDefault, GpioIntDis      , GpioHostDeepReset   , GpioTermNone    }}, //PM_SUS_STAT_ESPI_RST_N
  ...
  {GPIO_SKL_H_GPP_A18, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //ISH_GP_0_ALS (All SKU) - PEG2 RST_L
  ...
  {GPIO_SKL_H_GPP_B1,  {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioHostDeepReset   , GpioTermNone    }}, //DDR_VOLTAGE_SEL
  // Not Used {GPIO_SKL_H_GPP_B2, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioReset       , GpioTerm        }}, //NOT USED
  {GPIO_SKL_H_GPP_B3,  {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInInv   , GpioOutDefault, GpioIntLevel | GpioIntApic | GpioIntSci, GpioPlatformReset, GpioTermNone }}, //CPU_GP2/BT_RF_KILL_R_N/PEG2_WAKE_L
  ...
  {GPIO_SKL_H_GPP_B11, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInInv   , GpioOutDefault, GpioIntLevel     | GpioIntSci, GpioPlatformReset , GpioTermNone    }}, //EXT_PWR_GATEB / NOT USED
  ...
  {GPIO_SKL_H_GPP_B14, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //SPKR - PEG 1 RST_L
  ...
  {GPIO_SKL_H_GPP_E1,  {GpioPadModeNative2, GpioHostOwnDefault, GpioDirIn      , GpioOutDefault, GpioIntDefault  , GpioPlatformReset , GpioTermNone    }}, //SATAXPCIE_1_SATAGP_1_VISA2CH1_D0/SATA_ODD_PRSNT_R_N
  ...
  {GPIO_SKL_H_GPP_F10, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInInv   , GpioOutDefault, GpioIntLevel     | GpioIntSci,  GpioPlatformReset , GpioTermNone    }}, //SATA_SCLOCK/PCH_CONFIG_JUMPER
  {GPIO_SKL_H_GPP_F11, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInInv   , GpioOutDefault, GpioIntLevel     | GpioIntSci,  GpioPlatformReset , GpioTermNone    }}, //SATA_SLOAD/RSVD
  ...
  {GPIO_SKL_H_GPP_F14, {GpioPadModeGpio   , GpioHostOwnDefault, GpioDirInInv   , GpioOutDefault, GpioIntLevel    , GpioHostDeepReset   , GpioTermNone    }}, //H_SKTOCC_N
  ...
  {GPIO_SKL_H_GPP_F23, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //NFC_IRQ - PEG0 PERST_L
  ...
  {GPIO_SKL_H_GPP_G8,  {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //FAN_PWM_0 - PEG0 S2
  ...
  {GPIO_SKL_H_GPP_G11, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirIn      , GpioOutDefault, GpioIntLevel     | GpioIntSci, GpioPlatformReset , GpioTermNone    }}, //FAN_PWM_3/PEG2 S5 Power Enable
  {GPIO_SKL_H_GPP_G12, {GpioPadModeGpio   , GpioHostOwnAcpi   , GpioDirInInv   , GpioOutDefault, GpioIntEdge      | GpioIntSci, GpioHostDeepReset   , GpioTermNone    }}, //GSXDOUT/TBCIO_PLUG_EVENT
  ...
  // Not Used {GPIO_SKL_H_GPP_G16, {GpioPadMode       , GpioHostOwn       , GpioDir        , GpioOut       , GpioInt          | , GpioPlatformReset , GpioTermNone    }}, //GSXCLK/TB_FRC_PWR
  ...
  {GPIO_SKL_H_GPP_G20, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirInInv   , GpioOutDefault, GpioIntLevel     | GpioIntApic, GpioPlatformReset , GpioTermNone    }}, //TEST_SETUP_MENU
  {GPIO_SKL_H_GPP_G21, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //P_INTF_N (SPI TPM PIRQ) - PEG1 S2
  ...
  {GPIO_SKL_H_GPP_H12, {GpioPadModeGpio   , GpioHostOwnGpio   , GpioDirOut     , GpioOutHigh   , GpioIntDis      , GpioPlatformReset , GpioTermNone    }}, //SML2ALERTB/NOT USED - PEG2 S2
...
#endif  // _GPIO_TABLE_DVP_PINEVALLEY_H
