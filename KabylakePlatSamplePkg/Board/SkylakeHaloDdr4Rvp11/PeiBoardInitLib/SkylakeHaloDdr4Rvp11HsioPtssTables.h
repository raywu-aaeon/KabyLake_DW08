/** @file
    Skylake Halo DDR4 Rvp11 HSIO PTSS H File
...
#ifndef SKYLAKE_HALO_DDR4_RVP11_HSIO_PTSS_H_
#define SKYLAKE_HALO_DDR4_RVP11_HSIO_PTSS_H_

#include <Library/PeiPolicyUpdateLib/PchHsioPtssTables.h>

//BoardId SkylakeHaloDdr4Rvp11
HSIO_PTSS_TABLES PchHHsioPtss_Bx_SkylakeHaloDdr4Rvp11[] = {
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Bx_SkylakeHaloDdr4Rvp11);

//BoardId SkylakeHaloDdr4Rvp11
HSIO_PTSS_TABLES PchHHsioPtss_Dx_SkylakeHaloDdr4Rvp11[] = {
  {{4, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{5, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{6, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{7, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Dx_SkylakeHaloDdr4Rvp11);


//BoardId SkylakeHaloDdr4Rvp11Ppv
HSIO_PTSS_TABLES PchHHsioPtss_Bx_SkylakeHaloDdr4Rvp11Ppv[] = {
  {{4, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{5, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{6, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{7, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Bx_SkylakeHaloDdr4Rvp11Ppv);


//BoardId SkylakeHaloDdr4Rvp11Ppv
HSIO_PTSS_TABLES PchHHsioPtss_Dx_SkylakeHaloDdr4Rvp11Ppv[] = {
  {{4, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{5, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{6, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
  {{7, V_PCH_PCR_FIA_LANE_OWN_PCIEDMI, 0x164, 0x00080000, (UINT32) ~0x1F0000}, PchPcieTopoUnknown},
...
UINT16 HSIO_PTSS_TABLE_SIZE(PchHHsioPtss_Dx_SkylakeHaloDdr4Rvp11Ppv);

#endif // SKYLAKE_HALO_DDR4_RVP11_HSIO_PTSS_H_
