  ...
  )
{
  ...
  //
  // RPPO-SKL-0019: RoyalParkOverrideBegin,  Check for special EFI_SMM_SAVE_STATE_REGISTER_IO
  //
  if (Register == SMM_SAVE_STATE_REGISTER_SMBASE_INDEX) {
    ZeroMem (Buffer, Width);
    CopyMem (Buffer, &mCpuHotPlugData.SmBase[CpuIndex], Width);

    return EFI_SUCCESS;
  }
  //
  // RPPO-SKL-0019: RoyalParkOverrideEnd
  //
  ...
  )
{
  ...
  if (SmmS3ResumeState == NULL) {   // RPPO-SKL-0022
  ...
  )
{
  ...
  for (Index = 0; Index < NumberOfCpus; Index++) {
    ...
    if (DestinationRegisterTableList[Index].RegisterTableEntry == NULL) {   // RPPO-SKL-0022
      return;                                                               // RPPO-SKL-0022
    }                                                                       // RPPO-SKL-0022
  ...
  )
{
  ...
  if (mAcpiCpuData.MtrrTable == 0) {  // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;      // RPPO-SKL-0022
  }                                   // RPPO-SKL-0022
  ...
  if (mAcpiCpuData.GdtrProfile == 0) {    // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;          // RPPO-SKL-0022
  }                                       // RPPO-SKL-0022
  ...
  if (mAcpiCpuData.IdtrProfile == 0) {    // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;          // RPPO-SKL-0022
  }                                       // RPPO-SKL-0022
  ...
  if (mAcpiCpuData.PreSmmInitRegisterTable == 0) {    // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;                      // RPPO-SKL-0022
  }                                                   // RPPO-SKL-0022
  ...
  if (mAcpiCpuData.RegisterTable == 0) {  // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;          // RPPO-SKL-0022
  }                                       // RPPO-SKL-0022
  ...
  if (mGdtForAp == NULL) {        // RPPO-SKL-0022
    return EFI_OUT_OF_RESOURCES;  // RPPO-SKL-0022
  }                               // RPPO-SKL-0022
...
Done:
  ...
  //
  // Configure Haswell SMRR2 register.
  //
  HaswellConfigSmrr2 ();    // RPPO-SKL-0017
  return EFI_SUCCESS;
}
  ...
  )
{
  ...
  TileDataSize = sizeof (SMRAM_SAVE_STATE_MAP) + sizeof (TXT_PROCESSOR_SMM_DESCRIPTOR);    // RPPO-SKL-0018
  ...
  )
{
  ...
  if (SmramRanges == NULL) {    // RPPO-SKL-0022
    return;                     // RPPO-SKL-0022
  }                             // RPPO-SKL-0022
  ...
  if (CurrentSmramRange == NULL) {  // RPPO-SKL-0022
    return;                         // RPPO-SKL-0022
  }                                 // RPPO-SKL-0022
  ...
  )
{
  ...
  //
  // Check if SMM Code Access Check feature is supported by the processor.
  //
  if ((AsmReadMsr64 (EFI_MSR_SMM_MCA_CAP) & SMM_CODE_ACCESS_CHK_BIT) != 0) {    // RPPO-SKL-0017
    //
