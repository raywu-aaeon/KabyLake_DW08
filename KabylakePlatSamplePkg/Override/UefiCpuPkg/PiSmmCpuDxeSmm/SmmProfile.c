  ...
  )
{
  ...
  if (NumberOfMmioDescriptors != 0) {
    ...
    if (mProtectionMemRange == NULL) {  // RPPO-SKL-0022
    ...
    if (mSplitMemRange == NULL) {   // RPPO-SKL-0022
      return;                       // RPPO-SKL-0022
    }                               // RPPO-SKL-0022
...
{
  //
  // RPPO-KBL-0046: RoyalParkOverrideBegin
  //
  /*
  EFI_STATUS                        Status;
  ...
  */
  ...
  //
  // RPPO-KBL-0046: RoyalParkOverrideEnd
  //
