...
#include <PiSmmCpuDxeSmm.h>   // RPPO-SKL-0018
...
//
// RPPO-SKL-0019: RoyalParkOverrideBegin, For Client CPU
//
#define SMM_SAVE_STATE_REGISTER_MAX_INDEX             5
//
...
CONST CPU_SMM_SAVE_STATE_LOOKUP_ENTRY mSmmCpuWidthOffset[] = {
  ...
  {4, 4, SMM_CPU_OFFSET (x64.SMBASE)    , SMM_CPU_OFFSET (x64.SMBASE)    , 0                                 , TRUE }, // EFI_SMM_SAVE_STATE_REGISTER_SMBASE      = 11,  RPPO-SKL-0019
...
// AMI_OVERRIDE_START >>> If ins/outs is executing on a thread, a page fault will occur if SMI is generated.
//  VOID                        *IoMemAddr;
// AMI_OVERRIDE_END <<<
...
{
  TXT_PROCESSOR_SMM_DESCRIPTOR       *Psd;  // RPPO-SKL-0018
...
//
// RPPO-SKL-0018: RoyalParkOverrideBegin
//
    Psd = (TXT_PROCESSOR_SMM_DESCRIPTOR*)(VOID*)(UINTN)(mCpuHotPlugData.SmBase[CpuIndex] + SMM_PSD_OFFSET);
    CopyMem (Psd, &gcPsd, sizeof (gcPsd));
    Psd->SmmSmiHandlerRip = (UINT64)(mCpuHotPlugData.SmBase[CpuIndex] + gcSmiHandlerOffset);
    Psd->SmmSmiHandlerRsp = (UINT64)gSmiStack;
//
// RPPO-SKL-0018: RoyalParkOverrideEnd
//
