...
DefinitionBlock (
    ...
    "xh_kbl-r", // OEM table ID  (8 byte string)
...
//end scope RHUB
  ...
  {
    Method(_UPC) { Return (TUPC(0x08)) }
    Method(_PLD) { Return (TPLD(1,1)) } //TBT USB Type C
  }
  ...
  {
    Method(_UPC) { Return (GUPC(1)) }
    Method(_PLD) { Return (GPLD(0,3)) } //M.2(1)BT KEY
  }

  Scope (\_SB.PCI0.XHC.RHUB.HS04)
  {
// AMI_OVERRIDE_START - Fix USB Type-C ACPI Validation fail in kabyLake R RVP Fab2 CRB.
#if 0
    Method(_UPC) { Return (TUPC(0x08)) }
    Method(_PLD) { Return (TPLD(1,4)) } //TBT USB Type C
#else
    Method(_UPC) { Return (TUPC(0x08)) }
    Method(_PLD) { Return (TPLD(1,2)) } //TBT USB Type C
#endif
// AMI_OVERRIDE_END - Fix USB Type-C ACPI Validation fail in kabyLake R RVP Fab2 CRB.
  }
  ...
  Scope (\_SB.PCI0.XHC.RHUB.HS06) {
    Method(_UPC) { Return (GUPC(1)) }
    Method(_PLD) { Return (GPLD(1,6)) } //walkup port 1
  }
  ...
  Scope (\_SB.PCI0.XHC.RHUB.HS08) {
    Method(_UPC) { Return (GUPC(1)) }
    Method(_PLD) { Return (GPLD(0,8)) } //M.2(3) WWAN
  }
  ...
  Scope (\_SB.PCI0.XHC.RHUB.SS03) {
    Method(_UPC) { Return (GUPC(1)) }
    Method(_PLD) { Return (GPLD(0,11)) } //SSIC
  }

  Scope (\_SB.PCI0.XHC.RHUB.SS04) {
    Method(_UPC) { Return (GUPC(1)) }
    Method(_PLD) { Return (GPLD(1,2)) } //paired with HS02
  }
