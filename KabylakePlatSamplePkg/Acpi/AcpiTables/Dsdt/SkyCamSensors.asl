...
Scope(\_SB.PCI0) {
  Method (IICB, 2, Serialized) { // Create I2C Bus resource template buffer
    // returns buffer with I2C Bus resource descriptor
    //Arg0 - SlaveAddress
    //Arg1 - ResourceSource
    Switch (ToInteger(Arg1)) {
      Case(0) { Name (IIC0, ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
        "\\_SB.PCI0.I2C0", 0x00, ResourceConsumer, DEV0,) })
        CreateWordField (IIC0, DEV0._ADR, DAD0)
        Store (Arg0, DAD0)
        Return (IIC0) }
      Case(1) { Name (IIC1 , ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
        "\\_SB.PCI0.I2C1", 0x00, ResourceConsumer, DEV1,) })
        CreateWordField (IIC1, DEV1._ADR, DAD1)
        Store (Arg0, DAD1)
        Return (IIC1) }
      Case(2) { Name (IIC2 , ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
        "\\_SB.PCI0.I2C2", 0x00, ResourceConsumer, DEV2,) })
        CreateWordField (IIC2, DEV2._ADR, DAD2)
        Store (Arg0, DAD2)
        Return (IIC2) }
      Case(3) { Name (IIC3 , ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
        "\\_SB.PCI0.I2C3", 0x00, ResourceConsumer, DEV3,) })
        CreateWordField (IIC3, DEV3._ADR, DAD3)
        Store (Arg0, DAD3)
        Return (IIC3) }
      Case(4) { Name (IIC4 , ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
        "\\_SB.PCI0.I2C4", 0x00, ResourceConsumer, DEV4,) })
        CreateWordField (IIC4, DEV4._ADR, DAD4)
        Store (Arg0, DAD4)
        Return (IIC4) }
      Default { Name (IIC5 , ResourceTemplate () { I2cSerialBus (0, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
  ...
  Method (PINR, 2, Serialized) { // Create GPIO resource template buffer
    ...
    // Arg1 - Group Number
    Name (GPIR, ResourceTemplate () { GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly, "\\_SB.PCI0.GPI0", 0x00, ResourceConsumer, GPID,) { 0xFFFF } })
    CreateWordField (GPIR, GPID._PIN, PINF)
    Store(Add(Multiply(24, Arg1), Arg0), PINF)
    Return (GPIR)
  }
    ...
    If (LEqual (Arg0, 0)) { // If Control Logic Device0 is to be used
      If (LEqual (C0TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger(L0BS)) { // I2C bus
          case (0) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C0}) }
          case (1) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C1}) }
          case (2) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C2}) }
          case (3) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C3}) }
          case (4) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C4}) }
          case (5) { Return (Package() {\_SB.PCI0.DSC0, \_SB.PCI0.I2C5}) }
          default { Return (Package() {\_SB.PCI0.DSC0}) }
        }
      }
      If (LGreater(C0TP, 1)) { Return (Package() {\_SB.PCI0.CLP0}) } // when Control Logic Type is of type PMIC add dependency on CLP0
    }
    If (LEqual (Arg0, 1)) { // If Control Logic Device1 is to be used
      If (LEqual (C1TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger(L1BS)) { // I2C bus
          case (0) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C0}) }
          case (1) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C1}) }
          case (2) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C2}) }
          case (3) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C3}) }
          case (4) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C4}) }
          case (5) { Return (Package() {\_SB.PCI0.DSC1, \_SB.PCI0.I2C5}) }
          default { Return (Package() {\_SB.PCI0.DSC1}) }
        }
      }
      If (LGreater(C1TP, 1)) { Return (Package() {\_SB.PCI0.CLP1}) } // when Control Logic Type is of type PMIC add dependency on CLP1
    }
    If (LEqual (Arg0, 2)) { // If Control Logic Device2 is to be used
      If (LEqual (C2TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger(L2BS)) { // I2C bus
          case (0) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C0}) }
          case (1) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C1}) }
          case (2) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C2}) }
          case (3) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C3}) }
          case (4) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C4}) }
          case (5) { Return (Package() {\_SB.PCI0.DSC2, \_SB.PCI0.I2C5}) }
          default { Return (Package() {\_SB.PCI0.DSC2}) }
        }
      }
      If (LGreater(C2TP, 1)) { Return (Package() {\_SB.PCI0.CLP2}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    If (LEqual (Arg0, 3)) { // If Control Logic Device3 is to be used
      If (LEqual (C3TP, 1)) { // If Type of control logic is Discrete
        Switch (ToInteger(L3BS)) { // I2C bus
          case (0) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C0}) }
          case (1) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C1}) }
          case (2) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C2}) }
          case (3) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C3}) }
          case (4) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C4}) }
          case (5) { Return (Package() {\_SB.PCI0.DSC3, \_SB.PCI0.I2C5}) }
          default { Return (Package() {\_SB.PCI0.DSC3}) }
        }
      }
      If (LGreater(C3TP, 1)) { Return (Package() {\_SB.PCI0.CLP3}) } // when Control Logic Type is of type PMIC add dependency on CLP2
    }
    Return (Package() {\_SB.PCI0})
  }
  ...
  Device (DSC0) { // Control Logic Device 0 when Discrete is selected
    ...
    Method (CLDB) {
      Name (PAR, Buffer() {
        ...
        0x00,                 // Reserved            (Offset 4)
        0x00,                 // Reserved            (Offset 5)
        0x00,                 // Reserved            (Offset 6)
    ...
    Method (_DSM, 4, NotSerialized) { // _DSM: Device-Specific Method
      If(LEqual(Arg0,ToUUID("79234640-9E10-4FEA-A5C1-B5AA8B19756F"))) { /*DsmGPIO*/
        ...
        If (LEqual (Arg2, 2)) { Return (GPPI(C0F0, Add(Multiply(24, C0G0), C0P0), C0I0, C0A0)) }
        // Function 3 ( GPIO 1:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 3)) { Return (GPPI(C0F1, Add(Multiply(24, C0G1), C0P1), C0I1, C0A1)) }
        // Function 4 ( GPIO 2:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 4)) { Return (GPPI(C0F2, Add(Multiply(24, C0G2), C0P2), C0I2, C0A2)) }
        // Function 5 ( GPIO 3:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 5)) { Return (GPPI(C0F3, Add(Multiply(24, C0G3), C0P3), C0I3, C0A3)) }
        Return (Buffer() {0x00})
      }
      Return (Buffer() {0})
    }
  ...
  Device (DSC1) { // Control Logic Device 1 when Discrete is selected
    ...
    Method (_DSM, 4, NotSerialized) { // _DSM: Device-Specific Method
      If(LEqual(Arg0,ToUUID("79234640-9E10-4FEA-A5C1-B5AA8B19756F"))) { /*DsmGPIO*/
        ...
        // Function 2 ( GPIO 0:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 2)) { Return (GPPI(C1F0, Add(Multiply(24, C1G0), C1P0), C1I0, C1A0)) }
        // Function 3 ( GPIO 1:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 3)) { Return (GPPI(C1F1, Add(Multiply(24, C1G1), C1P1), C1I1, C1A1)) }
        // Function 4 ( GPIO 2:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 4)) { Return (GPPI(C1F2, Add(Multiply(24, C1G2), C1P2), C1I2, C1A2)) }
        // Function 5 ( GPIO 3:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 5)) { Return (GPPI(C1F3, Add(Multiply(24, C1G3), C1P3), C1I3, C1A3)) }
      }
      Return (Buffer() {0})
    }
  }
  ...
  Device (DSC2) { // Control Logic Device 2 when Discrete is selected
    ...
    Method (_DSM, 4, NotSerialized) { // _DSM: Device-Specific Method
      If(LEqual(Arg0,ToUUID("79234640-9E10-4FEA-A5C1-B5AA8B19756F"))) { /*DsmGPIO*/
        ...
        // Function 2 ( GPIO 0:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 2)) { Return (GPPI(C2F0, Add(Multiply(24, C2G0), C2P0), C2I0, C2A0)) }
        // Function 3 ( GPIO 1:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 3)) { Return (GPPI(C2F1, Add(Multiply(24, C2G1), C2P1), C2I1, C2A1)) }
        // Function 4 ( GPIO 2:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 4)) { Return (GPPI(C2F2, Add(Multiply(24, C2G2), C2P2), C2I2, C2A2)) }
        // Function 5 ( GPIO 3:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 5)) { Return (GPPI(C2F3, Add(Multiply(24, C2G3), C2P3), C2I3, C2A3)) }
      }
      Return (Buffer() {0})
    }
  }
  ...
  Device (DSC3) { // Control Logic Device 3 when Discrete is selected
    ...
    Method (_DSM, 4, NotSerialized) { // _DSM: Device-Specific Method
      If(LEqual(Arg0,ToUUID("79234640-9E10-4FEA-A5C1-B5AA8B19756F"))) { /*DsmGPIO*/
        ...
        // Function 2 ( GPIO 0:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 2)) { Return (GPPI(C3F0, Add(Multiply(24, C3G0), C3P0), C3I0, C3A0)) }
        // Function 3 ( GPIO 1:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 3)) { Return (GPPI(C3F1, Add(Multiply(24, C3G1), C3P1), C3I1, C3A1)) }
        // Function 4 ( GPIO 2:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 4)) { Return (GPPI(C3F2, Add(Multiply(24, C3G2), C3P2), C3I2, C3A2)) }
        // Function 5 ( GPIO 3:bit31-24:Active Value. 23-16:Initial Value. 15-8:PinNo. 0-7:Function )
        If (LEqual (Arg2, 5)) { Return (GPPI(C3F3, Add(Multiply(24, C3G3), C3P3), C3I3, C3A3)) }
      }
      Return (Buffer() {0})
    }
  }
  ...
  Device (CLP0) { // Control Logic Device 0 when PMIC is selected
    ...
    Method (_DEP, 0, NotSerialized) {  // _DEP: Operation Region Dependencies
      If (CL00) { // If CLP0 device is to be enabled
        If (LEqual (C0IB, 2)) { // If PMIC needs I2C2 controller
          Return (Package() {\_SB.PCI0.I2C2})
        }
        If (LEqual (C0IB, 3)) { // If PMIC needs I2C3 controller
          Return (Package() {\_SB.PCI0.I2C3})
        }
      }
      Return (Package() {\_SB.PCI0})
    }
    ...
    Method(_PLD, 0, Serialized) { // _PLD: Physical Location of Device
      ...
      CreateByteField(DerefOf(Index(PLDB,0)), 8, BPOS) // Position field
      Store (C0PL, BPOS)
      Return (PLDB)
    }
    Method (_DSM, 4, NotSerialized) {  // _DSM: Device-Specific Method
  ...
  Device (LNK0) {       // definition for Camera sensor module using Link0
    ...
    Method(SSDB)
    {
      Name(PAR, Buffer() {
        ...
        0x00,0x00,0x00,0x00,  // Reserved              (offset 97)
...
// AMI_OVERRIDE_START - For Skylake MRD support
    ...
    Method (_DEP, 0, NotSerialized) {   // _DEP - Operation Region Dependencies
      If (L1EN) { // If LNK1 device is to be enabled
        If (LEqual (L1CL, 0)) { // If Control Logic Device0 is to be used
          If (LGreater(C0TP, 1)) { Return (Package() {\_SB.PCI0.CLP0}) } // If Control Logic device is of PMIC type
          If (LEqual(C0TP, 1)) { Return (Package() {\_SB.PCI0.DSC0,\_SB.PCI0.I2C2}) } 
        }
        If (LEqual (L1CL, 1)) { // If Control Logic Device1 is to be used
          If (LGreater(C1TP, 1)) { Return (Package() {\_SB.PCI0.CLP1}) } // If Control Logic device is of PMIC type
          If (LEqual(C0TP, 1)) { Return (Package() {\_SB.PCI0.DSC1,\_SB.PCI0.I2C2}) } 
        }
        If (LEqual (L1CL, 2)) { // If Control Logic Device2 is to be used
          If (LGreater(C2TP, 1)) { Return (Package() {\_SB.PCI0.CLP2}) } 
          If (LEqual(C0TP, 1)) { Return (Package() {\_SB.PCI0.DSC2,\_SB.PCI0.I2C2}) } 
        }
        If (LEqual (L1CL, 3)) { // If Control Logic Device3 is to be used
          If (LGreater(C3TP, 1)) { Return (Package() {\_SB.PCI0.CLP3}) } 
          If (LEqual(C0TP, 1)) { Return (Package() {\_SB.PCI0.DSC3,\_SB.PCI0.I2C2}) } 
        }
      }
      Return (Package() {\_SB.PCI0})
    }
...
// AMI_OVERRIDE_START - For Skylake MRD support
#if !defined(ASL_SkylakeMRD_SUPPORT) || (ASL_SkylakeMRD_SUPPORT == 0)    
    Method (_DEP, 0, NotSerialized) {  // _DEP: Operation Region Dependencies
    ...
    Method(_CRS, 0x0, NotSerialized) {
      Name(SBUF, ResourceTemplate() {
        I2cSerialBus (0x10, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
          "\\_SB.PCI0.I2C2", 0x00, ResourceConsumer, ,) //sensor address 0x10
        I2cSerialBus (0x0E, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
          "\\_SB.PCI0.I2C2", 0x00, ResourceConsumer, ,) //VCM
        I2cSerialBus (0x50, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
          "\\_SB.PCI0.I2C2", 0x00, ResourceConsumer, ,) //EEPROM
    ...
    Method(_CRS, 0x0, NotSerialized) {
      Name(SBUF, ResourceTemplate() {
        I2cSerialBus (0x36, ControllerInitiated, 0x00061A80, AddressingMode7Bit,
          "\\_SB.PCI0.I2C4", 0x00, ResourceConsumer, ,)
      })
      Return (SBUF)
    }
    Method(_STA, 0, NotSerialized) { // _STA: Status
