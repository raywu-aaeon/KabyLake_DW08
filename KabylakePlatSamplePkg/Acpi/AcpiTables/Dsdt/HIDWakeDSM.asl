...
//External(\_SB.PCI0.LPCB.H_EC.UPBT, MethodObj)
    ...
    If (LEqual(Arg0, ToUUID("1730E71D-E5DD-4A34-BE57-4D76B6A2FE37")))
    {
      ...
      If(LEqual(Arg2, One))
      {
        Switch(ToInteger(DeRefOf(Index(Arg3, 0))))
        {
          ...
          {
// AMI_OVERRIDE_START - For CRB EC only
...
#endif  
// AMI_OVERRIDE_END - For CRB EC only
          }
...
// AMI_OVERRIDE_START - For CRB EC only
            ...
            {
              \_SB.PCI0.LPCB.H_EC.UPBT(0x80, One) // Arg0:Bit7 - Dock Indicator change request, Arg1:One - Set the target bit.
            }
#endif  
// AMI_OVERRIDE_END - For CRB EC only            
          }
...
// AMI_OVERRIDE_START - For CRB EC only
            ...
            If (CondRefOf(\_SB.PCI0.LPCB.H_EC.UPBT))
            {
              \_SB.PCI0.LPCB.H_EC.UPBT(0x80, Zero) // Arg0:Bit7 - Dock Indicator change request, Arg1:Zero - Clear the target bit.
            }
#endif  
// AMI_OVERRIDE_END - For CRB EC only            
          }
