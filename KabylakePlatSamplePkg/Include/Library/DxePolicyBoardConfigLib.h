...
/**
  This function performs DXE AMT Policy update by board configuration.
...
EFI_STATUS
EFIAPI
UpdateDxeAmtPolicyBoardConfig (
  IN OUT  AMT_POLICY_PROTOCOL        *DxeAmtPolicy
  );

/**
  This function performs DXE ME Policy update by board configuration.

  @param[in, out] DxeAmtPolicy    DXE ME Policy
...
/**
  ...
  @param[in, out] DxeAmtPolicy    DXE SA Policy
