/** @file
  SampleCode header file of the library for Intel CPU PEI Debug Policy initialization.
...
**/
#ifndef _PEI_CPU_POLICY_DEBUG_LIB_H_
#define _PEI_CPU_POLICY_DEBUG_LIB_H_
