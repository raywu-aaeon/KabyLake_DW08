  ...
  )
{
  ...
  //
  SmmIoWrite8 (EC_C_PORT, EC_C_SMI_QUERY);
  SmmIoRead8 (EC_D_PORT);
}
#endif
// AMI_OVERRIDE_END - EIP349813 : Please use a Token/Flag to determine whether EspiSlaveSmi is Registered or not.
