...
Scope(\_SB)
{
  ...
  Device(VIR2)
  {
    ...
    Name (VSCG, Package()
    {
      ...
      Package()
      {
        Package () {\_SB.PCI0.LPCB.H_EC.GEN3,14,0,500,0,200,2932},
        Package () {\_SB.PCI0.LPCB.H_EC.GEN4,14,0,500,0,300,2932}
      }
    })
    ...
    Name (VSCS, Package()
    {
      ...
      Package()
      {
        Package () {\_SB.PCI0.LPCB.H_EC.SEN3,14,0,500,0,200,2932},
        Package () {\_SB.PCI0.LPCB.H_EC.SEN4,14,0,500,0,300,2932}
      }
    })
    ...
    Method(VSCT, 0, Serialized, ,PkgObj)
    {
      If(LEqual(\PVSC, 1)) { // Check if VSCT for sensors should be returned
        Return (VSCS)
      } Else {
        Return (VSCG)
      }
