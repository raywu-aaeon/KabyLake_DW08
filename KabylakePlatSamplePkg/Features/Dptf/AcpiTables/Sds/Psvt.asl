...
Scope(\_SB.IETM)
{
  ...
  {
    2,
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 600, 3122, 9, 0x00010000, 5000, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 600, 3142, 9, 0x00010000, 4000, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 600, 3172, 9, 0x00010000, 2400, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 600, 3532, 9, 0x00010000, 2400, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.B0D4,           2,  20, 3682, 9, 0x00010000, 5000, 500, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.B0D4,           2,  20, 3702, 9, 0x00010000, 1500, 500, 10, 10, 0}
  })

  Name (PSV2, Package()
  {
    2,
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 300, 3042, 9, 0x00010000, 7000, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 300, 3112, 9, 0x00010000, 5700, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 300, 3152, 9, 0x00010000, 4400, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.LPCB.H_EC.GEN5, 2, 300, 3532, 9, 0x00010000, 4400, 250, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.B0D4,           2,  20, 3682, 9, 0x00010000, 7000, 500, 10, 10, 0},
    Package(){\_SB.PCI0.B0D4, \_SB.PCI0.B0D4,           2,  20, 3702, 9, 0x00010000, 1500, 500, 10, 10, 0}
  })
