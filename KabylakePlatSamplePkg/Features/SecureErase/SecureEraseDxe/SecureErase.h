...
**/
#ifndef __SECURE_ERASE_DRIVER_H__
#define __SECURE_ERASE_DRIVER_H__
...
/**
  Driver's entry point. Checks if secure erase has been requested via boot options,
  ...
  @retval          EFI_ABORTED         Secure erase has not been requested
**/
EFI_STATUS
EFIAPI
SecureEraseEntryPoint (
  IN EFI_HANDLE                        ImageHandle,
  IN EFI_SYSTEM_TABLE                 *SystemTabl
  );
