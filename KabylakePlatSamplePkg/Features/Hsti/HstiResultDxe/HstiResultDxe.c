...
// AMI_OVERRIDE_START - Use gAmiTseNVRAMUpdateGuid to notify HSTI SaveConfigurationChange event.
extern EFI_GUID gAmiTseNVRAMUpdateGuid;
// AMI_OVERRIDE_END - Use gAmiTseNVRAMUpdateGuid to notify HSTI SaveConfigurationChange event.
...
#else
  DEBUG((DEBUG_ERROR,"HstiResultDxe:: SaveConfigurationChange\n"));
