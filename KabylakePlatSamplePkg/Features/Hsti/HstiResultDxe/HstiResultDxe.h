...
#if 0  // AMI_OVERRIDE_START - Use gAmiTseNVRAMUpdateGuid to notify HSTI SaveConfigurationChange event.
#include <Guid/EventGroup.h>
#endif // AMI_OVERRIDE_END - Use gAmiTseNVRAMUpdateGuid to notify HSTI SaveConfigurationChange event.
