/** @file
  ...
  This driver will determine the default value settting for SMBIOS_TABLE_TYPE32.
...
//
GLOBAL_REMOVE_IF_UNREFERENCED MISC_SMBIOS_TABLE_DATA(SMBIOS_TABLE_TYPE32, MiscBootInfoStatus) = {
  {                                           // Hdr
