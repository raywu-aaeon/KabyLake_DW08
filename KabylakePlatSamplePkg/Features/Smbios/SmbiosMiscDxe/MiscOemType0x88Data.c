/** @file
  Type 0x88: Oem defined.
  This driver will determine the default value settting for SMBIOS_TABLE_TYPE0x88.
...
//
GLOBAL_REMOVE_IF_UNREFERENCED MISC_SMBIOS_TABLE_DATA(SMBIOS_TABLE_TYPE0x88, MiscOemType0x88) = {
  {                                     // Hdr
    EFI_SMBIOS_TYPE_OEM_DEFINED_0x88,   ///< Hdr.Type
    0x06,                               ///< Hdr.Length
    0                                   ///< Hdr.Handle
  },
  0,                                    ///< RawData
