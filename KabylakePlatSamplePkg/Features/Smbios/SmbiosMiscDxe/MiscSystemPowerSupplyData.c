/** @file
  ...
  This driver will determine the default value settting for SMBIOS_TABLE_TYPE39.
...
//
// Static (possibly build generated) System Power Supply data.
//
GLOBAL_REMOVE_IF_UNREFERENCED MISC_SMBIOS_TABLE_DATA(SMBIOS_TABLE_TYPE39, MiscSystemPowerSupply) = {
  {                                             // Hdr
    EFI_SMBIOS_TYPE_SYSTEM_POWER_SUPPLY,        ///< Hdr.Type
  ...
  0x8000,                                       ///< MaxPowerCapacity
  {                                             // PowerSupplyCharacteristics
    FALSE,                                      ///< Bit0: PowerSupplyHotReplaceable
    TRUE,                                       ///< Bit1: PowerSupplyPresent
    FALSE,                                      ///< Bit2: PowerSupplyUnplugged
    2,                                          ///< Bit3-6: InputVoltageRangeSwitch
    2,                                          ///< Bit7-9: PowerSupplyStatus
    2,                                          ///< Bit10-13: PowerSupplyType
    0                                           ///< Bit14-15: Reserved
  },
  0,                                            ///< InputVoltageProbeHandle
  0x0A,                                         ///< CoolingDeviceHandle
  0                                             ///< InputCurrentProbeHandle
};