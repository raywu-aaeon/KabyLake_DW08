...
#define MEMORY_EXTENDED_RATIO_MAX 31

// Indicates what index in FreqTable the 4133 frequency is.
#define FREQ_TABLE_INDEX_MEMORY_RATIO_MAX 50
...
**/
#if 0 // AMI_OVERRIDE_START - Move to OverClockSetup.c.
EFI_STATUS
EFIAPI
...
#endif // AMI_OVERRIDE_END - Move to OverClockSetup.c.
/**
