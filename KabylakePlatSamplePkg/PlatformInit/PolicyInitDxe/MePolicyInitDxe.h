/** @file
  Header file for the MePolicyInitDxe Driver.
...
**/
#ifndef _ME_POLICY_INIT_DXE_H_
#define _ME_POLICY_INIT_DXE_H_
...
/**
  Checkes the HECI protocol and send MEI message
...
VOID
EFIAPI
HeciPlatformDebugCapabilityMsgCallback (
  IN  EFI_EVENT                   Event,
  IN  VOID                        *Context
  )
;
