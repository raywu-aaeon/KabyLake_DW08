        ...
        STRING_REF Token)
{
    ...
    DEBUG((-1, "AMI HSTI get language and String, then append string to the table.\n\r"));
    ...
    Swprintf(NewString, ErrorString, BitNum, ErrorNum);
    DEBUG((-1, "...%S\n\r", NewString));    
 ...
 */
EFI_STATUS AmiHsti_PerformTestsAndPublish(IN EFI_EVENT Event, IN VOID *Context)
{
	DEBUG((-1, "AMI HSTI Callback.\n\r"));
...
//#endif
    ...
    StrCpy(AipTable->ImplementationID, ImplementationId);
    ...
    *String = 0;
    ...
    DEBUG((-1, "AMI HSTI - Publish default Table with only implemented bits set.\n\r"));
