...
#define EFI_IOB_PCI_PC_BUS_ENUM EFI_IOB_PCI_BUS_ENUM
#define EFI_IOB_PCI_PC_RES_ALLOC EFI_IOB_PCI_RES_ALLOC
#define EFI_IOB_PCI_PC_HPC_INIT EFI_IOB_PCI_HPC_INIT
