...
VOID EFIAPI InitString(EFI_HII_HANDLE HiiHandle, STRING_REF StrRef, CHAR16 *sFormat, ...);
CALLBACK_PARAMETERS* GetCallbackParameters();
#endif

//Boot Flow Definitions
// EF152FB4-7B2F-427D-BDB4-7E0A05826E64
#ifndef BOOT_FLOW_VARIABLE_GUID
    #if ( TSE_BUILD >= 0x1270) 
...
#ifndef BOOT_FLOW_CONDITION_RECOVERY
#define	BOOT_FLOW_CONDITION_RECOVERY            2
#endif

#ifndef BOOT_FLOW_CONDITION_FIRST_BOOT
#define	BOOT_FLOW_CONDITION_FIRST_BOOT          4
#endif

#ifndef BOOT_FLOW_CONDITION_PCI_OUT_OF_RESOURCE
#define BOOT_FLOW_CONDITION_PCI_OUT_OF_RESOURCE 9
#endif

#ifndef BOOT_FLOW_CONDITION_OS_UPD_CAP
