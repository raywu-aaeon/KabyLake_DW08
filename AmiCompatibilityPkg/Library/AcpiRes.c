...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_IRQ(UINT8 dsc_cnt, UINT8 ll, UINT8 he, UINT8 shr, ... )
{
    UINT8           i;
    UINT16          irq=0;
    VA_LIST         marker;
...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_IRQNoFlags(UINT8 dsc_cnt, ... )
{
    UINT8           i;
    VA_LIST         marker;
    UINT16          irq=0;
...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_DMA(UINT8 dsc_cnt, UINT8 typ, UINT8 bm, UINT8 siz, ... )
{
    UINT8           i, dma=0;
    VA_LIST         marker;
...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_StartDependentFn(UINT8 dsc_cnt,UINT8 pComp,UINT8 pPerf, ...)
{
    UINT8           i;
    VA_LIST         marker;
...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_StartDependentFnNoPri(UINT8 dsc_cnt, ...)
{
    UINT8               i;
    VA_LIST             marker;
...
//<AMI_PHDR_END>
//*************************************************************************
VOID* EFIAPI ASLM_VendorShort(UINT8 byte_cnt, ...)
{
    UINT8               i;
    VA_LIST             marker;
