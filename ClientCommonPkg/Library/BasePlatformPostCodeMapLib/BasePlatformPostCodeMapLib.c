/** @file
  PlatformPostCodeMap implementation.
...
// AMI_OVERRIDE_START >>> Sync to StatusCodeMapPei.c
...
// AMI_OVERRIDE_END <<< Sync to StatusCodeMapPei.c  
...
// AMI_OVERRIDE_START >>> Sync to StatusCodeMap.c
  { DXE_NVRAM_INIT, 0x61 },
  { DXE_SBRUN_INIT, 0x62 },
  { DXE_CPU_INIT, 0x63 },
// AMI_OVERRIDE_END <<< Sync to StatusCodeMap.c
