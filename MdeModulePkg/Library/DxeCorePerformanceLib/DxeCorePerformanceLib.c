...
//*** AMI PORTING BEGIN ***//
// Enhancement: Declare globals with GLOBAL_REMOVE_IF_UNREFERENCED
// to let linker remove the library when performance support is disabled
//
// The data structure to hold global performance data.
//
//GAUGE_DATA_HEADER    *mGaugeData;
GLOBAL_REMOVE_IF_UNREFERENCED GAUGE_DATA_HEADER    *mGaugeData;
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT32               mMaxGaugeRecords;

//
// The handle to install Performance Protocol instance.
//
//EFI_HANDLE           mHandle = NULL;
GLOBAL_REMOVE_IF_UNREFERENCED EFI_HANDLE           mHandle = NULL;

//
// Interfaces for Performance Protocol.
//
//PERFORMANCE_PROTOCOL mPerformanceInterface = {
GLOBAL_REMOVE_IF_UNREFERENCED PERFORMANCE_PROTOCOL mPerformanceInterface = {
  StartGauge,
  EndGauge,
  GetGauge
  };
...
GLOBAL_REMOVE_IF_UNREFERENCED PERFORMANCE_EX_PROTOCOL mPerformanceExInterface = {
  StartGaugeEx,
  EndGaugeEx,
  GetGaugeEx
  };
