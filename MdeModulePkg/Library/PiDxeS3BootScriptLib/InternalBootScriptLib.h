...
typedef struct {
    ...
    UINT64 Size;
} AMI_BUFFER_VALIDATION_MEM_ADDRESS_RANGE;

typedef struct {
	AMI_BUFFER_VALIDATION_MEM_ADDRESS_RANGE *MemRanges;
    UINT32 NumberOfMemoryRanges;
} AMI_BUFFER_VALIDATION_MEM_ADDRESS_RANGE_STR;
//*** AMI PORTING END *****//
