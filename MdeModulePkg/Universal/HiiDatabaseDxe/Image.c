...
//*** AMI PORTING BEGIN ***//
// edk2 bz 1135 fix: potential stack overflow while processing malformed BMP image
#ifndef MAX_UINT24
  ...
  )
{
  ...
  CopyRgbToGopPixel (PaletteValue, Palette->PaletteValue, MIN (PaletteNum, sizeof(PaletteValue)/sizeof(PaletteValue[0])));
  //*** AMI PORTING END *****//
  FreePool (Palette);
