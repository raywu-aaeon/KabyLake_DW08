  ...
  )
{
  ...
  //
  //*** AMI PORTING BEGIN ***//
  // edk2 bz 1134 fix: potential buffer overrun while processing
  // RAM disk with invalid address/size combination
  if (RamDiskSize > MAX_UINTN || RamDiskBase >= MAX_UINTN - RamDiskSize + 1) {
