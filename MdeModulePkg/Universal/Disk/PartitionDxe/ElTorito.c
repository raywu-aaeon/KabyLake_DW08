...
//*** AMI PORTING BEGIN ***//
//Workaround to support AmiFsUdf/AmiIso9660 media
//Since AmiFs* partition nodes claim whole drive we have recursive partition
//installation problem. To avoid this we allow CD_ROM and AmiFs* nodes to be
//installed only on physical partitions
