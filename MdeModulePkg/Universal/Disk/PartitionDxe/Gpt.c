  ...
  )
{
  ...
  //*** AMI PORTING BEGIN ***//
  // edk2 bz 1134 fix: potential buffer overflow while processing
  // physical block I/O devices with block size smaller than
  // the size of a master boot record.
  //
