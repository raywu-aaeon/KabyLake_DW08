...
//*** AMI PORTING BEGIN ***//
// Improvement: Provide a mechanism to override default page table creation logic
UINTN (*PageTableCreationFunctionPtr) (IN UINT8 PhysicalAddressBits, BOOLEAN Page1GSupport) = NULL;
//*** AMI PORTING END *****//  
...
{  
  ...
  //*** AMI PORTING BEGIN ***//
  // Improvement: Provide a mechanism to override default page table creation logic
  if (PageTableCreationFunctionPtr != NULL){
      UINTN PageTableAddress = PageTableCreationFunctionPtr(PhysicalAddressBits, Page1GSupport);
      if (PageTableAddress != 0) return PageTableAddress;
  }
  //*** AMI PORTING END *****//  
