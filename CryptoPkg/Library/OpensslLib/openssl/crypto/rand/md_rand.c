...
#if AMI_MODULE_PKG_VERSION >= 39
#if defined DISABLE_STDLIB_WRAPPER_METHODS && DISABLE_STDLIB_WRAPPER_METHODS==0
#if defined CRYPTO_CLANG_TOOL_BUILD && CRYPTO_CLANG_TOOL_BUILD==0
int _fltused = 1;
#endif
#endif
#endif
...
#endif
    time_t curr_time;	//Aptio V porting
    int do_stir_pool = 0;
...
#endif
	curr_time = local_time(NULL);	//Aptio
