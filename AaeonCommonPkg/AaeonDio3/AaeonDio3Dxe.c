    ...
    IN VOID                         *Context )
{
  ...
  UINT32    *Address;
	...
	if (EFI_ERROR (Status)) {
		// No GPNV Protocol was found. Register UpdateDioAcpiArea as callback instead.
    ...
    if (EFI_ERROR (Status)) {
      TRACE((-1,"ERROR: AaeonDio3: Register UpdateDioAcpiArea as callback failed. This will cause BSOD.\n"));
      Debug_80(0xBF,1);
      Debug_80(0xEE,1);
      Debug_80(0xBF,1);
      Debug_80(0xEE,1);
