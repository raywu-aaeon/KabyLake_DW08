  ...
  )
{
  ...
  MePeiConfig->MeUnconfigIsValid         = FspsUpd->FspsConfig.MeUnconfigIsValid;

  //
  // Test policies
  //
  MePeiConfig->EndOfPostMessage          = FspsUpd->FspsTestConfig.EndOfPostMessage;
  MePeiConfig->DisableD0I3SettingForHeci = FspsUpd->FspsTestConfig.DisableD0I3SettingForHeci;
