...
/**
    This Function notifies the call back for EndOfDxe and ReadyToBoot event 
...
/**
    This Function gets called while entering into Setup 
...
RegisterEventsForLockUnlock()
{
    ...
    // Create Callback for the End of Dxe to Lock the Variable Access
...
/**
    ...
    @retval TRUE            if Variable is SETUPPASSWD
    ...
    VOID        *Data )
{
    ...
    if (EFI_UNSUPPORTED == Status){
        ...
        UnicodeStrToAsciiStr(VariableName,VarNameinChar8);
