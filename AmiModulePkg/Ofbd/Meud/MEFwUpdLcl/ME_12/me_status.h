...
#define STATUS_ECC_POINT_NOT_ON_CURVE 0x110
#define STATUS_ECC_POINT_AT_INFINITY  0x111
#define STATUS_ECC_PRIV_KEY_OUT_OF_RANGE  0x112
#define STATUS_ECC_KEYPAIR_INVALID 0x113

// RPMC-specific error codes
#define STATUS_RPMC_CRYPTO_ERROR     0x180
#define STATUS_RPMC_FPF_ERROR        0x181
...
#define STATUS_LOAD_ERROR_NON_CRITICAL                                        0x320
