...
//#define     OFBD_FS_OACU        BIT18     // Already defined in OACU module
#define     OFBD_FS_FLASH_LOG   BIT19
...
//#define OFBD_EXT_TC_OACU        0x5D      // Already defined in OACU module
#define OFBD_EXT_TC_SFU         0x70
#define OFBD_EXT_TC_AFU_MFG     0x71
#define OFBD_EXT_TC_BGU         0x72
#define OFBD_EXT_TC_FLASH_LOG   0x73
...
typedef struct 
{
    ...
    UINT16  dwRetSts;       ///< Bit 0: OA data is invalid, tell the utility stop the flash procedure                               - OFBD_RS_OA_DATA_IS_INVALID
                            ...
                            ///< Bit 4: BIOS has updated the OA, so tell the utility to normally exit                               - OFBD_RS_OA_UPDATE_SUCCESS_STOP_AFU
                            ///< Bit 5: BIOS has updated the OA, and tell the utility continue other flash procedure                - OFBD_RS_OA_UPDATE_SUCCESS_CONTINUE_AFU           
                            ///< Bit 6~14: Reserved
...
#define OFBD_TC_OA_UPDATA_OAD_NOTIFY    BIT01
...
#define OFBD_RS_OA_UPDATE_SUCCESS_STOP_AFU      BIT04
#define OFBD_RS_OA_UPDATE_SUCCESS_CONTINUE_AFU  BIT05
...
///
/// Extern Ofbd buffer total size
///
extern UINT16   gOFBD_Size;
