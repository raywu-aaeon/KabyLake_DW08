        ...
        for(i=0; i<Device->HostData->RhpcCount; i++){
            ...
            if(!rhpc->BusFound){
                if(!DPCmp(Device->DevicePath, rhpc->HpcLocation->HpbDevicePath)){
                    ...
                    rhpc->BusFound=TRUE;
                    Device->HotPlug=rhpc;
                    DEBUG((DEBUG_VERBOSE,"PciHP: Found HP Bus Bridge @ B%X|D%X|F%X \n\n", Device->Address.Addr.Bus,Device->Address.Addr.Device, Device->Address.Addr.Function));
                }
            }
            ...
            if(!rhpc->Initialized){
                ...
                //-----------------------------------
                    ...
                    DEBUG((DEBUG_VERBOSE,"PciBus: Found RHPC @ B%X|D%X|F%X \n", Device->Address.Addr.Bus,Device->Address.Addr.Device, Device->Address.Addr.Function));
                }
            }
...
/**
    ...
    @param Device Pointer PCI Devicse Private Data. 
...
/**
    ...
    @param RootBridge Pointer PCI Devicse Private Data. 
