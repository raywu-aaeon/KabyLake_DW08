...
/**
    ...
    @param[in] SioLd      SPIO Device Private Data section.
    @param[in] Volatile   Volatile or None Volatile.
  
    @retval EFI_STRING    Device variable name.
**/
...
/**
    ...
    @param[in] Index              The entry in mSpioDeviceList[].
  
    @retval EFI_SUCCESS           Get _PRS success.
    @retval EFI_NOT_FOUND         Can't find any _PRS.
    @retval EFI_OUT_OF_RESOURCES  Resource allocate fail.    
**/
...
/**
    This functions will collect Fdc _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect PS2 keyboard _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect PS2 mouse _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect Uart _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect LPT _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect Game _PRS from legacy concept,it is not support ACPI.
...
/**
    This functions will collect Mpu401 _PRS from legacy concept,it is not support ACPI.
...
/**
    This function will collect _PRS from Aml code which support ACPI.

    @param[in] Dev                SPIO Device Private Data section.
    @param[in] PrsName            SPIO Device PRS object name.
    @param[in] Index              The entry in mSpioDeviceList[].
  
    @retval EFI_SUCCESS           Get _PRS success.
    @retval EFI_NOT_FOUND         Can't find any _PRS.
    @retval EFI_OUT_OF_RESOURCES  Resource allocate fail. 
    @retval EFI_NOT_AVAILABLE_YET ACPI support protocol not installed yet.
    @retval EFI_INVALID_PARAMETER PRS descriptor invalid.     
**/
...
/**
    ...
    @param[in] Device             SPIO Device Private Data section.
    @param[in] InitStep           SPIO Device initial step.
...
/**
    This is a routine to launch Init Function isSetResources.
        
    @param[in] Device             SPIO Device Private Data section.
    @param[in] RegType            Indicate which resource type.
      
    @retval EFI_SUCCESS           Set resource success.
    @retval EFI_NOT_FOUND         Can't find any _PRS.
    @retval EFI_OUT_OF_RESOURCES  Resource allocate fail. 
    @retval EFI_NOT_AVAILABLE_YET ACPI support protocol not installed yet.
    @retval EFI_INVALID_PARAMETER PRS descriptor invalid.     
...
/**
    ...
    @param[in] IndexP    LPC index port.
    @param[in] DataP     LPC data port.
    @param[in] BankReg   Bank register offset, if NULL skip programing bank number.
    @param[in] BankNo    Bank number.
    @param[in] LpcReg    Register who content the wanted value.
...
/**
    This routine will save to Boot Script for S3 resume.

    @param[in] Reg16       IO register.
    @param[in] Data8       IO data.
    @param[in] SaveState   A pointer to the EFI_S3_SAVE_STATE_PROTOCOL instance.
**/
...
/**
    This routine will save select logic device to Boot Script for S3 resume.

    @param[in] idxReg     LPC index port.
    @param[in] dataReg    LPC data port.
    @param[in] LdnSel     Register offset which can select logic device.
    @param[in] Ldn        Logic device number.
    @param[in] SaveState  A pointer to the EFI_S3_SAVE_STATE_PROTOCOL instance.   
**/
...
/**
    This routine will save SIO initial table to Boot Script for S3 resume.
...
/**
    This routine will save runtime SIO initial table to Boot Script for S3 resume.

    @param[in] Base       Runtime register offset.
    @param[in] Table      SIO initial table.
    @param[in] Count      Table data count.
    @param[in] SaveState  A pointer to the EFI_S3_SAVE_STATE_PROTOCOL instance.  
**/
