...
1. Use BIOS image '$(UNSIGNED_BIOS_ROM)'$(EOL)\
   ...
   with the following files present in the binary:$(EOL)\
...
ifneq ($(wildcard $(FWpub)),$(FWpub))
	...
	@echo Re-build the BIOS with a valid public key file OR use cryptocon switch '-n -k key' to insert the key into the BIOS binary.
endif
ifeq ($(FWCAPSULE_CERT_FORMAT),1)
