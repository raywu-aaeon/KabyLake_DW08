...
typedef struct {
    ...
    UINT16                  EDSTT;                  // Offset 317:316
    UINT8                   DSTO;                   // Offset 318
    UINT8                   FWUG;                   // Offset 319
    UINT16                  KAS;                    // Offset 321:320
    UINT16                  HCTMA;                  // Offset 323:322
    UINT16                  MNTMT;                  // Offset 325:324
    UINT16                  MXTMT;                  // Offset 327:326
    UINT32                  SANICAP;                // Offset 331:328
    UINT8                   Reserved2[180];         // Offset 511:332
...
typedef EFI_STATUS
(EFIAPI *AMI_NVME_CONTROLLER_STOP)(
    IN  AMI_NVME_CONTROLLER_PROTOCOL    *NvmeController
);
...
//----------------------------Queue1 for Nvme Cmds------------------------------------------------------
  ...
  //-----------------------------------------------------------------------------------------------------  
    ...
    AMI_NVME_CONTROLLER_STOP    NvmeStopController;              // Function used to stop/release resources in S3 path
