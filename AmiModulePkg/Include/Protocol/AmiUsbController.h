...
struct _DEV_DRIVER {
    ...
    UINT8           SubClass;
    UINT8           Protocol;
    VOID            (*FnDeviceInit)(VOID);
    UINT8           (*FnCheckDeviceType)(DEV_INFO*, UINT8, UINT8, UINT8);
    DEV_INFO*       (*FnConfigureDevice)(HC_STRUC*, DEV_INFO*, UINT8*, UINT16, UINT16);
    UINT8           (*FnDisconnectDevice)(DEV_INFO*);
    VOID            (*FnDriverRequest)(DEV_INFO*, URP_STRUC*);
};
...
typedef struct {
    UINT8       Flag;
    UINT8       (*FnHcdStart) (HC_STRUC*);
    UINT8       (*FnHcdStop) (HC_STRUC*);
    UINT8       (*FnHcdEnumeratePorts) (HC_STRUC*);
    UINT8       (*FnHcdDisableInterrupts) (HC_STRUC*);
    UINT8       (*FnHcdEnableInterrupts) (HC_STRUC*);
    UINT8       (*FnHcdProcessInterrupt) (HC_STRUC*);
    UINT32      (*FnHcdGetRootHubStatus) (HC_STRUC*, UINT8, BOOLEAN);
    UINT8       (*FnHcdDisableRootHub) (HC_STRUC*,UINT8);
    UINT8       (*FnHcdEnableRootHub) (HC_STRUC*,UINT8);
    UINT16      (*FnHcdControlTransfer) (HC_STRUC*,DEV_INFO*,UINT16,UINT16,UINT16,UINT8*,UINT16);
    UINT32      (*FnHcdBulkTransfer) (HC_STRUC*,DEV_INFO*,UINT8,UINT8*,UINT32);
    UINT32      (*FnHcdIsocTransfer) (HC_STRUC*,DEV_INFO*,UINT8,UINT8*,UINT32,UINT8*);
    UINT16      (*FnHcdInterruptTransfer) (HC_STRUC*, DEV_INFO*, UINT8, UINT16, UINT8*, UINT16);
    UINT8       (*FnHcdDeactivatePolling) (HC_STRUC*,DEV_INFO*);
    UINT8       (*FnHcdActivatePolling) (HC_STRUC*,DEV_INFO*);
    UINT8       (*FnHcdEnableEndpoints) (HC_STRUC*,DEV_INFO*,UINT8*);    
    UINT8       (*FnHcdDisableKeyRepeat) (HC_STRUC*);
    UINT8       (*FnHcdEnableKeyRepeat) (HC_STRUC*);
    UINT8       (*FnHcdInitDeviceData) (HC_STRUC*, DEV_INFO*, UINT32, UINT8**);
    UINT8       (*FnHcdDeinitDeviceData) (HC_STRUC*,DEV_INFO*);
    UINT8       (*FnHcdResetRootHub) (HC_STRUC*,UINT8);
    UINT8       (*FnHcdClearEndpointState) (HC_STRUC*,DEV_INFO*,UINT8);
    UINT8       (*FnHcdGlobalSuspend) (HC_STRUC*);
    UINT8       (*FnHcdSmiControl) (HC_STRUC*, BOOLEAN);
} HCD_HEADER;
...
**/
typedef struct {
    EFI_STATUS  (*FnHcdMemAlloc) (VOID**, UINT16);
    EFI_STATUS  (*FnHcdMemFree) (VOID*, UINT16);
} HCD_MEM_HEADER;
