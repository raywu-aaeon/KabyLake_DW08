...
//**********************************************************************
/** @file
  Definitions related to BDS boot option maintenance infrastructure.
**/
#ifndef __BOOT_OPTIONS__H__
#define __BOOT_OPTIONS__H__
#include <Token.h>
#include <AmiDxeLib.h>
#include <Pci.h>
...
#ifndef LEGACY_DEV_ORDER_GUID
#if TSE_BUILD >= 0x1270
#define LEGACY_DEV_ORDER_GUID   \
    { 0xA56074DB, 0x65FE, 0x45F7, { 0xBD, 0x21, 0x2D, 0x2B, 0xDD, 0x8E, 0x96, 0x52 } }
#else
// Backward compatibility. Older versions of AmiTsePkg(AmiVfr.h) define this GUID in the following format.
// When formats do not match build breaks with the double definition error.
#define LEGACY_DEV_ORDER_GUID   \
    { 0xA56074DB, 0x65FE, 0x45F7, 0xBD, 0x21, 0x2D, 0x2B, 0xDD, 0x8E, 0x96, 0x52 }
#endif
#endif
