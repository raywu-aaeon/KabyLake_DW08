...
//**********************************************************************
//**********************************************************************
/** @file AmiGenericSio.h

    AMI Aptio V Sio Implementation Private Data Structure Definitions.
**/ 
...
#ifndef TRACE_SIO
#define TRACE_SIO DEBUG_INFO
#endif

#if SIO_DEBUG_MESSAGES
#define SIO_TRACE(Arguments) DEBUG(Arguments)
#else
