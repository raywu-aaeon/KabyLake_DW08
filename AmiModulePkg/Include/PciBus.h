...
/**
 ...
 Fields:        
   ...
   ------------------------------------------------------------------
    ...
    BarOffset       UINTN             If BarType==tBarMaxType this field specifies BAR offset. 
                                      If Device Bar offset doesn't match with BarOffset, Bar Adjustment will be ignored when BarType==tBarMaxType.
...
typedef struct _AMI_FIXED_BRIDGE_LEN_REMOVAL {

    EFI_HANDLE    RBHandle;
    UINT8         ResType [rtMaxRes];
    UINT64        Length;
    UINT64        Gra;
    BOOLEAN       FixedResource;
    
}AMI_FIXED_BRIDGE_LEN_REMOVAL;
#endif
//**********************************************************************
//**********************************************************************
//**                                                                  **
