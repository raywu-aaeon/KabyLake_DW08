...
#define PCI_GLOBAL_BMEDMA_QID   0x702A
...
typedef struct _ROM_POLICY_VAR {
    ...
    BOOLEAN     IsSlot;     //Flag  to Identify if SLOT
    UINT32      SlotNum;    //Slot Number
    UINT8       AslName[5]; //Asl Name (mandatory for Onboard ROM devices)
} ROM_POLICY_VAR;
