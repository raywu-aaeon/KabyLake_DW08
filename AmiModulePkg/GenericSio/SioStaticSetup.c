...
/**
    ...
    @param[in,out] Buffer   Temp string for this change.
	@param[in]     Value    Value need change to string.
    @param[in]     Flags    Comma type.
    @param[in]     Width    Character number for value.
    
    @retval UINTN   String length.
**/
UINTN EFIAPI
HHMEfiValueToString (
...
/**
    ...
    @param[in,out]  Buffer           Defautl string.  ": N/A    ". Buffer length should more than 0x10.
    @param[in]      StringToChged    Raw data.
    @param[in]      STCLen           String total length.
    @param[in]      HeadBuf          Header of string.
    @param[in]      HeadLen          Header length.
    @param[in]      Flag             TRUE indicate is a float data, False indicate it's a integet data.
    @param[in]      MidPos           Float point position. eg: 0.076 is 0x3.
    @param[in]      TailBuf          Unit of string data.
    @param[in]      TailLen          Length of unit.
**/
