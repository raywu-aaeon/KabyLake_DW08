...
/**
    This is the standard EFI driver entry point called for Sio Dxe initlaization.

    @param ImageHandle              ImageHandle of the loaded driver.
    @param SystemTable              Pointer to the System Table.

    @retval EFI_SUCCESS             If everything good.
    @retval EFI_OUT_OF_RESOURCES    Resources is not enough to install AmiBoardSioInitProtocol.
**/
