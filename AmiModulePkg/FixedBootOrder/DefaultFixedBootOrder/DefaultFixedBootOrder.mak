...
## Strip the attribute string presented at suffix 
FBO_UEFI_DEVICE_WITH_ATTRIBUTE := $(FBO_UEFI_DEVICE)
FBO_UEFI_DEVICE := $(subst _DISABLED,,$(FBO_UEFI_DEVICE))
FBO_LEGACY_DEVICE_WITH_ATTRIBUTE := $(FBO_LEGACY_DEVICE)
FBO_LEGACY_DEVICE := $(subst _DISABLED,,$(FBO_LEGACY_DEVICE))
FBO_DUAL_DEVICE := $(subst _DISABLED,,$(FBO_DUAL_DEVICE))
FBO_DUAL_DEVICE1_WITH_ATTRIBUTE := $(FBO_DUAL_DEVICE1)
FBO_DUAL_DEVICE1 := $(subst _DISABLED,,$(FBO_DUAL_DEVICE1))
...
FBO_DUAL_DEVICE2 = $(FBO_DUAL_DEVICE1) FAKE
FBO_DUAL_INDEX := $(wordlist 1,$(words $(FBO_DUAL_DEVICE2)),$(NONE_ZERO_INDEX_ARRAY))
...
GAWK_UEFI_DEVICE := $(subst $(SPACE)$(SPACE),+,$(FBO_UEFI_DEVICE_WITH_ATTRIBUTE))

## Prepare Gawk tool Legacy Data ##
$(GAWK_LEGACY_DEVICE) : $(BUILD_DIR)/Token.mak 
GAWK_LEGACY_DEVICE := $(subst $(SPACE)$(SPACE),+,$(FBO_LEGACY_DEVICE_WITH_ATTRIBUTE))

## Prepare Gawk tool Dual Data ##
$(GAWK_DUAL_DEVICE) : $(BUILD_DIR)/Token.mak 
GAWK_DUAL_DEVICE := $(subst $(SPACE),+,$(FBO_DUAL_DEVICE1_WITH_ATTRIBUTE))
