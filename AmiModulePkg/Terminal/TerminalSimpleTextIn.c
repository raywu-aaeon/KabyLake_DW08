...
// 0x00..0x1f
    EfiKeySpaceBar, 0x39, // 0x20
    EfiKeyE1,  0x02, // 0x21 33 !
    EfiKeyC11, 0x28, // 0x22 34 "
    EfiKeyE3,  0x04, // 0x23 35 #
    EfiKeyE4,  0x05, // 0x24 36 $
    EfiKeyE5,  0x06, // 0x25 37 %
    EfiKeyE7,  0x08, // 0x26 38 &
    EfiKeyC11, 0x28, // 0x27 39 '
    EfiKeyE9,  0x0a, // 0x28 40 (
    EfiKeyE10, 0x0b, // 0x29 41 )
    EfiKeyE8,  0x09, // 0x2a 42 *
    EfiKeyE12, 0x0d, // 0x2b 43 +
    EfiKeyB8,  0x33, // 0x2c 44 ,
    EfiKeyE11, 0x0c, // 0x2d 45 -
    EfiKeyB9,  0x34, // 0x2e 46 .
    EfiKeyB10, 0x35, // 0x2f 47 /
    EfiKeyE10, 0x0b, // 0x30 48 0
    EfiKeyE1,  0x02, // 0x31 49 1
    EfiKeyE2,  0x03, // 0x32 50 2
    EfiKeyE3,  0x04, // 0x33 51 3
    EfiKeyE4,  0x05, // 0x34 52 4
    EfiKeyE5,  0x06, // 0x35 53 5
    EfiKeyE6,  0x07, // 0x36 54 6
    EfiKeyE7,  0x08, // 0x37 55 7
    EfiKeyE8,  0x09, // 0x38 56 8
    EfiKeyE9,  0x0a, // 0x39 57 9
    EfiKeyC10, 0x27, // 0x3a 58 :
    EfiKeyC10, 0x27, // 0x3b 59 ;
    EfiKeyB8,  0x33, // 0x3c 60 <
    EfiKeyE12, 0x0d, // 0x3d 61 =
    EfiKeyB9,  0x34, // 0x3e 62 >
    EfiKeyB10, 0x35, // 0x3f 63 ?
    EfiKeyE2,  0x03, // 0x40 64 @
    EfiKeyC1,  0x1e, // 0x41 65 A
    EfiKeyB5,  0x30, // 0x42 66 B
    EfiKeyB3,  0x2e, // 0x43 67 C
    EfiKeyC3,  0x20, // 0x44 68 D
    EfiKeyD3,  0x12, // 0x45 69 E
    EfiKeyC4,  0x21, // 0x46 70 F
    EfiKeyC5,  0x22, // 0x47 71 G
    EfiKeyC6,  0x23, // 0x48 72 H
    EfiKeyD8,  0x17, // 0x49 73 I
    EfiKeyC7,  0x24, // 0x4a 74 J
    EfiKeyC8,  0x25, // 0x4b 75 K
    EfiKeyC9,  0x26, // 0x4c 76 L
    EfiKeyB7,  0x32, // 0x4d 77 M
    EfiKeyB6,  0x31, // 0x4e 78 N
    EfiKeyD9,  0x18, // 0x4f 79 O
    EfiKeyD10, 0x19, // 0x50 80 P
    EfiKeyD1,  0x10, // 0x51 81 Q
    EfiKeyD4,  0x13, // 0x52 82 R
    EfiKeyC2,  0x1f, // 0x53 83 S
    EfiKeyD5,  0x14, // 0x54 84 T
    EfiKeyD7,  0x16, // 0x55 85 U
    EfiKeyB4,  0x2f, // 0x56 86 V
    EfiKeyD2,  0x11, // 0x57 87 W
    EfiKeyB2,  0x2d, // 0x58 88 X
    EfiKeyD6,  0x15, // 0x59 89 Y
    EfiKeyB1,  0x2c, // 0x5a 90 Z
    EfiKeyD11, 0x1a, // 0x5b 91 [
    EfiKeyD13, 0x2b, // 0x5c 92 BackSlash
    EfiKeyD12, 0x1b, // 0x5d 93 ]
    EfiKeyE6,  0x07, // 0x5e 94 ^
    EfiKeyE11, 0x0c, // 0x5f 95 _
    EfiKeyE0,  0x29, // 0x60 96 `
    EfiKeyC1,  0x1e, // 0x61 97 a
    EfiKeyB5,  0x30, // 0x62 98 b
    EfiKeyB3,  0x2e, // 0x63 99 c
    EfiKeyC3,  0x20, // 0x64 100 d
    EfiKeyD3,  0x12, // 0x65 101 e
    EfiKeyC4,  0x21, // 0x66 102 f
    EfiKeyC5,  0x22, // 0x67 103 g
    EfiKeyC6,  0x23, // 0x68 104 h
    EfiKeyD8,  0x17, // 0x69 105 i
    EfiKeyC7,  0x24, // 0x6a 106 j
    EfiKeyC8,  0x25, // 0x6b 107 k
    EfiKeyC9,  0x26, // 0x6c 108 l
    EfiKeyB7,  0x32, // 0x6d 109 m
    EfiKeyB6,  0x31, // 0x6e 110 n
    EfiKeyD9,  0x18, // 0x6f 111 o
    EfiKeyD10, 0x19, // 0x70 112 p
    EfiKeyD1,  0x10, // 0x71 113 q
    EfiKeyD4,  0x13, // 0x72 114 r
    EfiKeyC2,  0x1f, // 0x73 115 s
    EfiKeyD5,  0x14, // 0x74 116 t
    EfiKeyD7,  0x16, // 0x75 117 u
    EfiKeyB4,  0x2f, // 0x76 118 v
    EfiKeyD2,  0x11, // 0x77 119 w
    EfiKeyB2,  0x2d, // 0x78 120 x
    EfiKeyD6,  0x15, // 0x79 121 y
    EfiKeyB1,  0x2c, // 0x7a 122 z
    EfiKeyD11, 0x1a, // 0x7b 123 {
    EfiKeyD13, 0x2b, // 0x7c 124 |
    EfiKeyD12, 0x1b, // 0x7d 125 }
    EfiKeyE0,  0x29, // 0x7e 126 ~
    EfiKeyDel, 0x53, // 0x7f 127 Del
};
