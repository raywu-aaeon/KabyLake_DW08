...
#define XHCI_PCI_ADDRESS( ControllerIndex, Register )  EFI_PEI_PCI_CFG_ADDRESS( \
...
#define XHCI_FIXED_DELAY_US(Usb3Hc, microseconds ) \
    Usb3Hc->StallPpi->Stall( Usb3Hc->PeiServices, Usb3Hc->StallPpi, microseconds);

//    CountTime(milliseconds * 1000, PM_BASE_ADDRESS);

#ifndef PEI_XHCI_READY_TIMEOUT_MS
#define PEI_XHCI_READY_TIMEOUT_MS       100
#endif

#ifndef PEI_XHCI_HALT_TIMEOUT_MS
#define PEI_XHCI_HALT_TIMEOUT_MS        32
#endif

#ifndef PEI_XHCI_RESET_TIMEOUT_MS
#define PEI_XHCI_RESET_TIMEOUT_MS       800
#endif

#ifndef PEI_XHCI_RESET_DELAY_MS
#define PEI_XHCI_RESET_DELAY_MS         1
#endif

#ifndef PEI_XHCI_EP_RUNNING_TIMEOUT_MS
#define PEI_XHCI_EP_RUNNING_TIMEOUT_MS  10
#endif
...
#define PEI_XHCI_RESET_USB2_PORT_TIMEOUT_MS         200
#endif

#ifndef PEI_XHCI_DISABLE_USB2_PORT_TIMEOUT_MS
#define PEI_XHCI_DISABLE_USB2_PORT_TIMEOUT_MS         20
#endif

#ifndef PEI_XHCI_PORT_RESET_TIMEOUT_MS
#define PEI_XHCI_PORT_RESET_TIMEOUT_MS                  200
#endif

#ifndef PEI_XHCI_PORT_LINK_RECOVERY_TIMEOUT_MS
#define PEI_XHCI_PORT_LINK_RECOVERY_TIMEOUT_MS          200
#endif

#ifndef PEI_XHCI_PORT_LINK_POLLING_TIMEOUT_MS
#define PEI_XHCI_PORT_LINK_POLLING_TIMEOUT_MS           500
#endif

#ifndef PEI_XHCI_PORT_LINK_INACTIVE_TIMEOUT_MS
#define PEI_XHCI_PORT_LINK_INACTIVE_TIMEOUT_MS          12
#endif
...
EFI_STATUS  XhciProcessInterrupt(
    EFI_PEI_SERVICES    **PeiServices,
    USB3_CONTROLLER     *Usb3Hc
);
