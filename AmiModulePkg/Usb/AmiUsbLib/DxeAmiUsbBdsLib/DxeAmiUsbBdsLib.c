            ...
            case XHCI_EXT_CAP_SUPPORTED_PROTOCOL:
                ...
                if (((XHCI_EXT_PROTOCOL*)XhciExtCap)->MajorRev == XHCI_EXT_PROTOCOL_MAJOR_REV_02) {
                    ...
                    USB_DEBUG(DEBUG_INFO, DEBUG_LEVEL_3, "XHCI: USB2 Support Protocol %x, PortOffset %x PortCount %x\n", 
                        (UINTN*)(BaseAddress + CurPtrOffset), Usb3Hc->Usb2Protocol.PortOffset, Usb3Hc->Usb2Protocol.PortCount);
                    ...
                    if (((XHCI_EXT_PROTOCOL*)XhciExtCap)->MinorRev == XHCI_EXT_PROTOCOL_MINOR_REV_00) {
                        ...
                        USB_DEBUG(DEBUG_INFO, DEBUG_LEVEL_3, "XHCI: USB3.0 Support Protocol %x, PortOffset %x PortCount %x\n", 
                          (UINTN*)(BaseAddress + CurPtrOffset), Usb3Hc->Usb3Protocol.PortOffset, Usb3Hc->Usb3Protocol.PortCount);
                        ...
                        if ((Usb3Hc->Usb3xProtocolCount) && (Usb3xProtocolCount < Usb3Hc->Usb3xProtocolCount)) {
                            ...
                            USB_DEBUG(DEBUG_INFO, DEBUG_LEVEL_3, "XHCI: USB3.x Support Protocol %x, PortOffset %x PortCount %x\n",
                              (UINTN*)(BaseAddress + CurPtrOffset), Usb3xProtocol->PortOffset, Usb3xProtocol->PortCount);
                            Usb3xProtocolCount++;
                        }
                    }
                }
