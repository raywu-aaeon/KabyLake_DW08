...
/** @file
    DXE instance of the DxeAmiUsbHcLib library class.
**/
#include <AmiDef.h>
#include <UsbDef.h>

extern EFI_GUID gAmiDxeUsbHcdProtocolGuid;

HCD_HEADER    *gDxeUsbHcdTable = NULL;
...
{ 
    ...
    gDxeUsbHcdTable = UsbHcdTable;

    // Install Dxe USB Hcd protocol
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdStart == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdStart(HcStruc);
}
/**
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdStop == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdStop(HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnumeratePorts == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnumeratePorts(HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableInterrupts == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableInterrupts(HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableInterrupts == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableInterrupts(HcStruc);
}
/**
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdProcessInterrupt == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdProcessInterrupt(HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdGetRootHubStatus == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdGetRootHubStatus(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableRootHub == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableRootHub(
               HcStruc, PortNum);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableRootHub == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableRootHub(
               HcStruc, PortNum);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdControlTransfer == NULL) return 0;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdControlTransfer(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdBulkTransfer == NULL) return 0;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdBulkTransfer(
...
/**
    ...
    @retval Value           For blocking transfer - amount of data transferred, for non-blocking transfer 0
                            ...
                            gUsbData->UsbLastCommandStatusExtended
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdIsocTransfer==NULL) return 0;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdIsocTransfer(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdInterruptTransfer==NULL) return 0;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdInterruptTransfer(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableKeyRepeat == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDisableKeyRepeat(
               HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableKeyRepeat==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableKeyRepeat(
               HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableEndpoints == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdEnableEndpoints(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdActivatePolling == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdActivatePolling(
               HcStruc, DevInfo);
}
/**
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDeactivatePolling == NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDeactivatePolling(
               HcStruc, DevInfo);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdInitDeviceData==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdInitDeviceData(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDeinitDeviceData==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdDeinitDeviceData(
               HcStruc, DevInfo);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdResetRootHub==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdResetRootHub(
               HcStruc, PortNum);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdClearEndpointState==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdClearEndpointState(
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdGlobalSuspend==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdGlobalSuspend(
               HcStruc);
}
...
)
{
    ...
    if (gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdSmiControl==NULL) return USB_ERROR;
    return gDxeUsbHcdTable[GET_HCD_INDEX(HcStruc->HcType)].FnHcdSmiControl(
               HcStruc, Enable);
}
