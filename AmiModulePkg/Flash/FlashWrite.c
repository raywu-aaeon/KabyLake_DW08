...
)
{
    ...
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashReadCommand));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashEraseCommand));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashEraseCommandEx));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashProgramCommand));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashBlockWriteEnable));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashBlockWriteDisable));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashDeviceWriteEnable));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashDeviceWriteDisable));
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashVirtualFixup));    
    Status = pRS->ConvertPointer(0, (VOID**)&(FlashAPI->FlashPartNumber));
