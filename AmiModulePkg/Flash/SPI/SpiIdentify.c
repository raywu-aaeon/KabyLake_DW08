...
)
{
    ...
    switch ( (UINT16)MfgDevId ) {
        ...
        case ADESTO_AT25SF641 :
            ...
            MemCpy ( pFlashDeviceNumber, "ADESTO AT25SF641", 16 );
            break;
        case ADESTO_AT25SL641 :
            mExFlashPart.FlashCapacity = 0x800000;
            Atmel_26DF.WriteStatusEnable.Opcode = SPI_AT26DF_COMMAND_WRITE_S_EN;
            Atmel_26DF.SectorSize = SECTOR_SIZE_4KB;
            MemCpy ( pFlashDeviceNumber, "ADESTO AT25SL641", 16 );
            break;
        case ADESTO_AT25SL128A :
            mExFlashPart.FlashCapacity = 0x1000000;
            Atmel_26DF.WriteStatusEnable.Opcode = SPI_AT26DF_COMMAND_WRITE_S_EN;
            Atmel_26DF.SectorSize = SECTOR_SIZE_4KB;
            MemCpy ( pFlashDeviceNumber, "ADESTO AT25SL128A", 17 );
            break;
...
)
{
    ...
    switch ( (UINT16)MfgDevId ) {
        ...
        case XMC_25QUxx_ID :
            ...
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "XMC 25QU Series", 15 );
            break;
		case XMC_25QHxx_ID :
            Stm_25PE.SectorSize = SECTOR_SIZE_4KB;
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "XMC 25QH Series", 15 );
            break;	
		...
		case MXIC_25Rxx35_ID :
            ...
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "MXIC 25R Series", 15 );
            break;	
        ...
        case SPANSION_25FLxxL_ID :
            ...
            mExFlashPart.FlashCapacity = \
                                    StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "Spansion 25FL(L) Series", 23 );
            break;
		...
		case FM_25Mxx_ID :
            ...
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "FIDELIX 25M Series", 18 );
            break;	
        case SHFM_25Qxx_ID :
            Stm_25PE.SectorSize = SECTOR_SIZE_4KB;
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
        ...
        case ISSI_25WPxx_ID :
            ...
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "ISSI 25WP Series", 16 );
            break;
        case ESMT_25Lxx_ID :
        case ESMT_25LxxQ_ID :
            Stm_25PE.SectorSize = SECTOR_SIZE_4KB;
		...
		case XT_25Fxx_ID :
            ...
            Stm_25PE.Erase.Opcode = SPI_MXIC_M25L_COMMAND_ERASE;
            mExFlashPart.FlashCapacity = StmCheckMemoryCapacity( MfgDevId );
            MemCpy ( pFlashDeviceNumber, "XTX 25F Series", 14 );
			break;
        default :
            return  FALSE;
    }
