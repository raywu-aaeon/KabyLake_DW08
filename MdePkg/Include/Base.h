...
//*** AMI PORTING BEGIN ***//
//Backward compatibility support: _ReturnAddress is supported starting from Visual Studio 2010
#if defined(_MSC_EXTENSIONS) && !defined (__INTEL_COMPILER) && !defined (MDE_CPU_EBC) && _MSC_VER >= 1600
