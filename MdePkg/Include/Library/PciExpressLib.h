...
**/
//*** AMI PORTING BEGIN ***//
// Bug fix: The header uses macro PCI_ECAM_ADDRESS defined in IndustryStandard/PciExpress21.h, but does not include the header.
// We're also not including the header as it causes name conflicts with the older reference code.
#ifndef PCI_ECAM_ADDRESS
