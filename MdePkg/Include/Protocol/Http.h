...
typedef enum {
  ...
  // Older code had a typo in the identifier name that is fixed in this version,
  // but older versions of network stack are using original misspeled identifier.
  // This backward compatibility definition will be removed in future version of MdePkg.
  HTTP_STATUS_300_MULTIPLE_CHIOCES = HTTP_STATUS_300_MULTIPLE_CHOICES,
  //*** AMI PORTING END *****//  
