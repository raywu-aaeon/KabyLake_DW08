...
//---------------------------------------------------------------------------
    Method (H1SL, 1){
        ...
        If (LEqual(Arg0, 0)) {
            ...
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_TEMPERATURE_1_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_TEMPERATURE_2_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_TEMPERATURE_2_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_TEMPERATURE_3_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_TEMPERATURE_3_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_TEMPERATURE_4_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_TEMPERATURE_4_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_TEMPERATURE_5_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_TEMPERATURE_5_STRING, "\"", ), ), Local0)
#endif
        } ElseIf (LEqual(Arg0, 1)) {
            // Fan
            ...
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_3VCC_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VIN1_VCORE_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VIN1_VCORE_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VIN2_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VIN2_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VIN3_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VIN3_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VIN4_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VIN4_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VSB3V_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VSB3V_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_VBAT_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_VBAT_STRING, "\"", ), ), Local0)
#endif
#if ASL_F81966_5VSB_SUPPORT
            If (LEqual(Local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_F81966_5VSB_STRING, "\"", ), ), Local0)
#endif
        }
        Return (Local0)
    }
    ...
    Method (H1RS, 2){
        ...
        If (LEqual(Arg0, 0)) {
            ...
            If (LEqual(Arg1, ASL_F81966_FAN_1_STRING)) {                // FAN1
                ShiftLeft(HWA1, 8, Local0)                              // Get FAN1 count reading MSB
                Or(HWA0, Local0, Local0)                                // Get FAN1 count reading LSB
            ...
            ElseIf (LEqual(Arg1, ASL_F81966_FAN_2_STRING)) {            // FAN2
                ShiftLeft(HWB1, 8, Local0)                              // Get FAN2 count reading MSB
                Or(HWB0, Local0, Local0)                                // Get FAN2 count reading LSB
                Store (0, Local1)                                       // Local1 : T.B.D.
                Store (HCVF (Local0, Local1), Local0)
            }
#endif
            ...
            ElseIf (LEqual(Arg1, ASL_F81966_FAN_3_STRING)) {            // FAN3
                ShiftLeft(HWC1, 8, Local0)                              // Get FAN3 count reading MSB
                Or(HWC0, Local0, Local0)                                // Get FAN3 count reading LSB
                Store (0, Local1)                                       // Local1 : T.B.D.
                Store (HCVF (Local0, Local1), Local0)
            }
#endif
