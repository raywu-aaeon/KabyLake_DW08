...
//---------------------------------------------------------------------------
    Method (H1SL, 1){
        ...
        If (LEqual(Arg0, 0)) {
            ...
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_SYSTIN_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_CPUTIN_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_CPUTIN_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_AUXTIN_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_AUXTIN_STRING, "\"", ), ), Local0)
#endif
        } ElseIf (LEqual(Arg0, 1)) {
            // Fan
#if ASL_W83627DHG_SYSFANIN_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_SYSFANIN_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_CPUFANIN0_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_CPUFANIN0_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_AUXFANIN0_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_AUXFANIN0_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_CPUFANIN1_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_CPUFANIN1_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_AUXFANIN1_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_AUXFANIN1_STRING, "\"", ), ), Local0)
#endif
        } ElseIf (LEqual(Arg0, 2)) {
            // Voltage
#if ASL_W83627DHG_VCORE_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VCORE_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VIN0_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VIN0_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VIN1_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VIN1_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VIN2_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VIN2_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VIN3_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VIN3_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VCC3_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VCC3_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_AVCC_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_AVCC_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VSB3_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VSB3_STRING, "\"", ), ), Local0)
#endif
#if ASL_W83627DHG_VBAT_SUPPORT
            If (LEqual(local1, ZERO)) { Concatenate (Local0, ",", Local0) } Else { Decrement(Local1) }  // Start to append comma from secondary.
            Concatenate (Local0, Concatenate ("\"", Concatenate (ASL_W83627DHG_VBAT_STRING, "\"", ), ), Local0)
#endif
        }
        Return (Local0)
    }
...
//---------------------------------------------------------------------------
    Method (F1RC, 1){
        ...
        ElseIf (LEqual(Arg0, ASL_W83627DHG_CPUFANIN0_STRING)) {
            ...
            Store (DerefOf(Index(TFT2, And(HW49,0x07))), Local1)
        ...
        ElseIf (LEqual(Arg0, ASL_W83627DHG_AUXFANIN0_STRING)) {
            ...
            Store (DerefOf(Index(TFT3, And(ShiftRight(HW49,4),0x07))), Local1)
            Concatenate (Local0, Local1, Local0)
            Concatenate (Local0, ASL_W83627DHG_SMFC_FANOUT_SUFFIX, Local0)
            Return (Local0)
        }
        ElseIf (LEqual(Arg0, ASL_W83627DHG_CPUFANIN1_STRING)) {
            ...
            Store (DerefOf(Index(TFT4, And(ShiftRight(HW4A,5),0x07))), Local1)
            Concatenate (Local0, Local1, Local0)
            Concatenate (Local0, ASL_W83627DHG_SMFC_FANOUT_SUFFIX, Local0)
            Return (Local0)
        }
