...
//
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN0_VALUE);
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN1_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN2 reading
        // 
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN2_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN3 reading
        //   
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN3_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN4 reading
        //   
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN4_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN5 reading
        //   
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN5_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN6 reading
        //   
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN6_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
        //
        //   VIN7 reading
        //   
        ...
        if (EFI_ERROR(Status)) return ;
        Token = STRING_TOKEN(STR_IT851X_VIN7_VALUE);
        AaeonHHMCommon((UINT16)DataValue, VOLTAGE, Token, OddPos, HiiHandle);
