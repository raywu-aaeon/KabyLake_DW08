...
@param McodeStart        Start of microcode in FFS.
@param TotalMcodeSize    Size of microcode and empty space in FFS.
@param CountEmpty        TRUE if calculate blocks for empty space.
**/

VOID FillMicrocodeBlkMap(IN OUT UINT16 *BlkStart, IN UINT8 *McodeStart, IN UINT32 TotalMcodeSize, IN BOOLEAN CountEmpty)
{
    UINT8 *p = McodeStart;
    UINT8 *EndOfMcode = p + TotalMcodeSize;
