...
typedef struct {
  ...
  EFI_EVENT              LegacyBootEvent;  // AMI Porting - Adding LegacyBootEvent
  EFI_EVENT              LegacyToEfiSnpEvent;  // AMI Porting - Adding LegacyToEfiSnpEvent
  //
...
/**
  Nofication call back function for CTRL_ALT_DEL key sequence.
...
/**
  ...
  @param[in]  NotifyFunction    Notification function to be notified on snp shutown for the input handle
  
  @return EFI_STATUS
  @retval EFI_INVALID_PARAMETER If NotifyFunction parameter is NULL
...
/**
  ...
  @param[in]  Handle            Snp Handle to which notification function is registred
  @param[in]  NotifyFunction    Notification function which is registered already
  
  @return EFI_STATUS
  @retval EFI_INVALID_PARAMETER The input parameter is not registered already
