...
//AMI_OVERRIDE_START >>> Change for KGB, below macro is deprecated in UefiCpuPgk, add define here.
#ifndef MTRR_LIB_IA32_MTRR_DEF_TYPE
#define  MTRR_LIB_IA32_MTRR_DEF_TYPE                 0x2FF
#endif

#ifndef MTRR_LIB_CACHE_MTRR_ENABLED
...
//  DefaultsRestored = FALSE;
  ...
  ///
#ifndef FSP_FLAG
//  InitCmos (FALSE, &DefaultsRestored);	//AMI_OVERRIDE
#endif //FSP_FLAG
