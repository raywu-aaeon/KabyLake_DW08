...
// AMI_OVERRIDE_PCH0039_START >>> Add Token to support special case for Smbus busy HW delay.
#ifdef SMBUS_BUSY_WAIT_DELAY
#include <Library/TimerLib.h>

#define STALL_PERIOD                10 * 1                          ///< 10 microseconds
#define STALL_TIME                  1000000                         ///< 1 second
#endif
// AMI_OVERRIDE_PCH0039_END <<< Add Token to support special case for Smbus busy HW delay.
...
// AMI_OVERRIDE_PCH0039_START >>> Add Token to support special case for Smbus busy HW delay.
    ...
    if(StallIndex == StallTries) {
        DEBUG((DEBUG_INFO, "Timeout will be returned\n"));
        return RETURN_TIMEOUT;
    } else {
