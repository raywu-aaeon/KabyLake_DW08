...
// AMI_OVERRIDE_PCH0021_START >>>
#ifdef AMI_CRB_GPIO_OVERRIDE_SUPPORT_FLAG  
  // Only skip I2C0(D21F0)
  if (SerialIoI2cControllerNumber == 0) 
	  return EFI_SUCCESS;
#endif  

#ifndef AMI_CRB_I2C_IO_EXPANDER_SUPPORT_FLAG  
  if (SerialIoI2cControllerNumber == 4) 
	  return EFI_SUCCESS;
#endif
...
// AMI_OVERRIDE_PCH0021_START >>>
#ifdef AMI_CRB_GPIO_OVERRIDE_SUPPORT_FLAG  
  // Skip UART0(D30F0) and UART2(D25F0)
  if (SerialIoUartControllerNumber == 0 || SerialIoUartControllerNumber == 2) 
	  return EFI_SUCCESS;
#endif  
// AMI_OVERRIDE_PCH0021_END <<<
