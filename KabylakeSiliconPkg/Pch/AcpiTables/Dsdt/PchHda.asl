...
Device(HDAS)
{
  ...
  Method(_PS0, 0, Serialized)
  {
    ...
    If(LNotEqual(VDID, 0xFFFFFFFF)) {
      // Voltage margining setting for HDA (Arg0 = 0), active (Arg1 = 1)
  ...
  Method(_PS3, 0, Serialized)
  {
    ...
    //
    If(LNotEqual(VDID, 0xFFFFFFFF)) {
      // Voltage margining setting for HDA (Arg0 = 0), disactive (Arg1 = 0)
      // Enable Voltage Margining if Display is off
      \_SB.VMMH(0, 0)
    }
    //
    // AdvancedFeaturesEnd
