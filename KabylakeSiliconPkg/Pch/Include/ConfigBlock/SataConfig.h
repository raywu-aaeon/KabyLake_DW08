...
typedef struct {
  ...
  **/
  ...
  UINT32  CpuAttachedStorage :  1;         ///< 0: Disable; <b>1: Enable</b> RST CPU attached storage
...
/**
  ...
  <b>Revision 5</b>
   - Added CpuAttachedStorage in PCH_SATA_RST_CONFIG to enable RST CPU attached storage
**/
typedef struct {
  /**
