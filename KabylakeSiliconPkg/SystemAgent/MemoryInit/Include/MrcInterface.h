...
typedef enum {
  ...
  OemDdr4TxVrefRange,       ///<  before Ddr4 TxVref Range Optimization
...
typedef struct {
  ...
  UINT32 TXDQVREF : 1;   ///< BIT4  - TxDqVref Range Optimization
  UINT32 RsvdBits :27;
} TrainingStepsEn2;
...
//
// Extended max supported frequency in OC mode
// RefClk133: 31*266 + 133 = 8400 (using Odd ratio mode)
// RefClk100: 31*200 + 100 = 6300 (using Odd ratio mode)
//
#define MAX_FREQ_OC_EXT_133 f8400
#define MAX_FREQ_OC_EXT_100 f6300
...
// AMI_OVERRIDE_SA0026_START >>>
#ifdef NB_SMBIOS_TYPE_17_CUSTOMIZATION_FLAG
  NB_TYPE17_EXTRA_DATA NbSpdData;
#endif
// AMI_OVERRIDE_SA0026_END <<<
} MrcDimmSave;
...
typedef struct {
  ...
  UINT32  EnBER:1;                    ///<  - Define if EnBER is enabled for Rank Margin Tool: 0=Disable,<b>1=Enable</b>
  UINT32  Ddr4MixedUDimm2DpcLimit:1;  ///<  - Enable/Disable 2667 Frequency Limitation for DDR4 U-DIMM Mixed Dimm 2DPC population. <b>0 = Disabled</b>, 1 = Enabled
  UINT32  RsvdBits1:19;
  ...
  **/
  ...
  UINT8   Ddr4SkipRefreshEn;      ///< Offset 223 - Reserved.
  ...
  // TurnAround Timing
  //
  MrcTurnaroundTimes tRd2Rd;          ///< Offset 228 - User-defined overrides for Read-to-Read   Turn Around Timings. <b>0 = AUTO</b>
  MrcTurnaroundTimes tRd2Wr;          ///< Offset 232 - User-defined overrides for Read-to-Write  Turn Around Timings. <b>0 = AUTO</b>
  MrcTurnaroundTimes tWr2Rd;          ///< Offset 236 - User-defined overrides for Write-to-Read  Turn Around Timings. <b>0 = AUTO</b>
  MrcTurnaroundTimes tWr2Wr;          ///< Offset 240 - User-defined overrides for Write-to-Write Turn Around Timings. <b>0 = AUTO</b>

  UINT8   RMTLoopCount;               ///< Offset 244 - Indicates the Loop Count to be used for Rank Margin Tool Testing: 1=Minimal, 32=Maximum, 0=AUTO, <b>0=Default</b>
  UINT8   RsvdOffset245[3];           ///< Offset 245 - Reserved.
  UINT16  tRRD_L;                     ///< Offset 248 - User defined DDR4 Memory Timing tRRD_L value,  valid when MemoryProfile is CUSTOM_PROFILE: <b>0=AUTO</b>, 15=Maximum.
  UINT16  tRRD_S;                     ///< Offset 250 - User defined DDR4 Memory Timing tRRD_S value,  valid when MemoryProfile is CUSTOM_PROFILE: <b>0=AUTO</b>, 15=Maximum.
  UINT16  tWTR_L;                     ///< Offset 252 - User defined DDR4 Memory Timing tWTR_L value,  valid when MemoryProfile is CUSTOM_PROFILE: <b>0=AUTO</b>, 28=Maximum.
  UINT16  tWTR_S;                     ///< Offset 254 - User defined DDR4 Memory Timing tWTR_S value,  valid when MemoryProfile is CUSTOM_PROFILE: <b>0=AUTO</b>, 28=Maximum.
  ...
  UINT8            BdatSchema;                  ///< When BdatEnable is set to TRUE, this option selects the Schema version which will be used for the training results data format: 0=Schema 2, <b>1=Schema 6B</b>.
