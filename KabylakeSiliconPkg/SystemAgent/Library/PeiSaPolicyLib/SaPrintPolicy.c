  ...
  )
{
  ...
  GRAPHICS_PEI_PREMEM_CONFIG            *GtPreMemConfig;       // AdvancedFeaturesContent
  MEMORY_CONFIGURATION                  *MemConfig;
  PCIE_PEI_PREMEM_CONFIG                *PciePeiPreMemConfig;  // AdvancedFeaturesContent
  SWITCHABLE_GRAPHICS_CONFIG            *SgConfig;             // AdvancedFeaturesContent
  MEMORY_CONFIG_NO_CRC                  *MemConfigNoCrc;
  OVERCLOCKING_PREMEM_CONFIG            *OcPreMemConfig;       // AdvancedFeaturesContent
...
// KblGBegin
//
  DEBUG ((DEBUG_INFO, " SaRtd3.SgDelayAfterOffMethod : 0x%x\n", MiscPeiPreMemConfig->SgDelayAfterOffMethod));
  DEBUG ((DEBUG_INFO, " SaRtd3.SgDelayAfterLinkEnable: 0x%x\n", MiscPeiPreMemConfig->SgDelayAfterLinkEnable));
  DEBUG ((DEBUG_INFO, " SaRtd3.SgGenSpeedChangeEnable: 0x%x\n", MiscPeiPreMemConfig->SgGenSpeedChangeEnable));
//
// KblGEnd
//
  DEBUG ((DEBUG_INFO, "\n"));

  DEBUG ((DEBUG_INFO, " TxtImplemented : 0x%x\n", MiscPeiPreMemConfig->TxtImplemented));
  ...
  DEBUG ((DEBUG_INFO, " DmiVc1 : 0x%x\n", PciePeiPreMemConfig->DmiVc1));
  DEBUG ((DEBUG_INFO, " DmiVcm : 0x%x\n", PciePeiPreMemConfig->DmiVcm));
  ...
  DEBUG ((DEBUG_INFO, " PegGpioData.SaPegReset.GpioPad Group:%d, PadNumber:%d\n", GpioGetGroupIndexFromGpioPad (PciePeiPreMemConfig->PegGpioData.SaPegReset.GpioPad), GpioGetPadNumberFromGpioPad (PciePeiPreMemConfig->PegGpioData.SaPegReset.GpioPad)));
  DEBUG ((DEBUG_INFO, " PegGpioData.SaPegReset.Active : 0x%x\n", PciePeiPreMemConfig->PegGpioData.SaPegReset.Active));
#endif //MINTREE_FLAG
#ifndef MINTREE_FLAG
  ...
  ASSERT (OcPreMemConfig->Header.Revision == SA_OVERCLOCKING_PREMEM_CONFIG_REVISION);
  DEBUG ((DEBUG_INFO, " OcSupport : 0x%x\n", OcPreMemConfig->OcSupport));
  DEBUG ((DEBUG_INFO, " GtsMaxOcRatio : 0x%x\n", OcPreMemConfig->GtsMaxOcRatio));
  DEBUG ((DEBUG_INFO, " GtsVoltageMode : 0x%x\n", OcPreMemConfig->GtsVoltageMode));
  DEBUG ((DEBUG_INFO, " GtsVoltageOffset : 0x%x\n", OcPreMemConfig->GtsVoltageOffset));
  DEBUG ((DEBUG_INFO, " GtsVoltageOverride : 0x%x\n", OcPreMemConfig->GtsVoltageOverride));
  DEBUG ((DEBUG_INFO, " GtsExtraTurboVoltage : 0x%x\n", OcPreMemConfig->GtsExtraTurboVoltage));
  ...
  )
{
  ...
  DEBUG((DEBUG_INFO, " SubSystemVendorId : 0x%x\n", MiscPeiConfig->DefaultSvidSid.SubSystemVendorId));
  DEBUG((DEBUG_INFO, " SubSystemId : 0x%x\n", MiscPeiConfig->DefaultSvidSid.SubSystemId));
  ...
  DEBUG ((DEBUG_INFO, " ProgramGtChickenBits : 0x%x\n", GtConfig->ProgramGtChickenBits));
#endif //MINTREE_FLAG
  ...
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, "------------------------ SKYCAM_CONFIG -----------------\n"));
  DEBUG ((DEBUG_INFO, " Revision : %d\n", SkyCamPolicy->Header.Revision));
  ASSERT (SkyCamPolicy->Header.Revision == SKYCAM_CONFIG_REVISION);
  DEBUG ((DEBUG_INFO, " SaImguEnable : 0x%x\n", SkyCamPolicy->SaImguEnable));
  ...
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, " PegSlotPowerLimitValue[%d] :", SA_PEG_MAX_FUN));
  for (Index = 0; Index < SA_PEG_MAX_FUN; Index++) {
    DEBUG ((DEBUG_INFO, " 0x%x", PciePeiConfig->PegSlotPowerLimitValue[Index]));
  }
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, " PegSlotPowerLimitScale[%d] :", SA_PEG_MAX_FUN));
  for (Index = 0; Index < SA_PEG_MAX_FUN; Index++) {
    DEBUG ((DEBUG_INFO, " 0x%x", PciePeiConfig->PegSlotPowerLimitScale[Index]));
  }
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, " PegPhysicalSlotNumber[%d] :", SA_PEG_MAX_FUN));
  for (Index = 0; Index < SA_PEG_MAX_FUN; Index++) {
    DEBUG ((DEBUG_INFO, " 0x%x", PciePeiConfig->PegPhysicalSlotNumber[Index]));
  }
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, " PegDeEmphasis[%d] :", SA_PEG_MAX_FUN));
  for (Index = 0; Index < SA_PEG_MAX_FUN; Index++) {
    DEBUG ((DEBUG_INFO, " 0x%x", PciePeiConfig->PegDeEmphasis[Index]));
  }
  DEBUG ((DEBUG_INFO, "\n"));
  DEBUG ((DEBUG_INFO, " PegMaxPayload[%d] :", SA_PEG_MAX_FUN));
  for (Index = 0; Index < SA_PEG_MAX_FUN; Index++) {
