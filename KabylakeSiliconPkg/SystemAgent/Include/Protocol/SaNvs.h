...
typedef struct {
  ...
  UINT32   Pcie0ClkReqMaskValue;                    ///< Offset 260     PCIe0 ClkReq Mask Value
  UINT32   Pcie1ClkReqMaskValue;                    ///< Offset 264     PCIe1 ClkReq Mask Value
  UINT32   Pcie2ClkReqMaskValue;                    ///< Offset 268     PCIe2 ClkReq Mask Value
  UINT16   DelayAfterOffMethod;                     ///< Offset 272     Delay after off method is called
  UINT16   DelayAfterLinkEnable;                    ///< Offset 274     Delay after link enable method is called
  UINT8    GenSpeedChangeEnable;                    ///< Offset 276     Enable Gen Speed Changes in PEG OnOff methods
// AMI_OVERRIDE_SA0001_START >>>
#if 0
  UINT8    Reserved0[223];                          ///< Offset 277:499
#else
  UINT32   SgMuxDid1;                               ///< Offset 277     DID1 Mux Setting
  UINT32   SgMuxDid2;                               ///< Offset 281     DID2 Mux Setting
  UINT32   SgMuxDid3;                               ///< Offset 285     DID3 Mux Setting
  UINT32   SgMuxDid4;                               ///< Offset 289     DID4 Mux Setting
  UINT32   SgMuxDid5;                               ///< Offset 293     DID5 Mux Setting
  UINT32   SgMuxDid6;                               ///< Offset 297     DID6 Mux Setting
  UINT32   SgMuxDid7;                               ///< Offset 301     DID7 Mux Setting
  UINT32   SgMuxDid8;                               ///< Offset 305     DID8 Mux Setting
  UINT8    PXFixedDynamicMode;                      ///< Offset 309     ATI 5.0 Fixed/Dynamic ATI 5.0 Fixed/Dynamic
  UINT32   EndpointBaseAddress;                     ///< Offset 310     Endpoint PCIe Base Address
  UINT32   VbiosSize;                               ///< Offset 314     dGPU Vbios Size
  UINT32   VbiosAddress;                            ///< Offset 318     dGPU Vbios Base Address
  UINT32   DgpuSsid;                                ///< Offset 322     dGPU SSID for MSHyBrid restore
  UINT8    NvdiaAudioFlag;                          ///< Offset 326 Flag for judging enable/disable NVIDIA HD audio bit    
  UINT8    Reserved0[173];                          ///< Offset 322:499
#endif
