...
typedef struct {
  ...
  UINT8                 LoadVbios    : 1;         ///< This field is used to describe if the dGPU VBIOS needs to be loaded: <b>0=Not load</b>, 1=Load
  UINT8                 ExecuteVbios : 1;         ///< This field is used to describe if the dGPU VBIOS need to be executed: <b>0=Not execute</b>, 1=Execute
/**
...
**/
  UINT8                 VbiosSource  : 1;
  UINT8                 RsvdBits0    : 5;         ///< Reserved for future use
  UINT8                 Rsvd[3];
} VBIOS_DXE_CONFIG;
#pragma pack(pop)
