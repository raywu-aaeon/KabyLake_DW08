  ...
  )
{
  ...
  ///
  /// Read AsmCpuid values for later, and check 64-bit
  ///
  ...
  )
{
  ...
  switch (CpuSku) {
    case EnumCpuTrad:
      SmbiosProcessorInfoData.ProcessorUpgrade = 0x32; ///< @todo: use ProcessorUpgradeSocketLGA1151 enum, once MdePkg is updated with SMBIOS 3.1.1 spec.
      break;

    case EnumCpuUlt:
      SmbiosProcessorInfoData.ProcessorUpgrade = 0x33; ///< @todo: use ProcessorUpgradeSocketBGA1356 enum, once MdePkg is updated with SMBIOS 3.1.1 spec.
      break;

    case EnumCpuHalo:
      SmbiosProcessorInfoData.ProcessorUpgrade = 0x34; ///< @todo: use ProcessorUpgradeSocketBGA1440 enum, once MdePkg is updated with SMBIOS 3.1.1 spec.
      break;

    case EnumCpuUlx:
      SmbiosProcessorInfoData.ProcessorUpgrade = 0x35; ///< @todo: use ProcessorUpgradeSocketBGA1515 enum, once MdePkg is updated with SMBIOS 3.1.1 spec.
      break;
  ...
  GetEnabledCount (&ThreadsPerCore, &EnabledCoreCount, NULL, NULL);

  SmbiosProcessorInfoData.CoreCount = SupportedCoreCount;
  SmbiosProcessorInfoData.EnabledCoreCount = EnabledCoreCount;
  SmbiosProcessorInfoData.ThreadCount = ThreadsPerCore * EnabledCoreCount;
