...
#define CPU_POWER_MGMT_TEST_CONFIG_REVISION 2
...
/**
  ...
  - Initial version.
  <b>Revision 2</b>:
  - Update Package CState Demotion and UnDemotion default.
**/
typedef struct {
  ...
  UINT32 PkgCStateDemotion             : 1;        ///<              Enable or Disable Package Cstate Demotion. <b>0: Disable</b>; 1: Enable.
  UINT32 PkgCStateUnDemotion           : 1;        ///<              Enable or Disable Package Cstate UnDemotion. <b>0: Disable</b>; 1: Enable.
